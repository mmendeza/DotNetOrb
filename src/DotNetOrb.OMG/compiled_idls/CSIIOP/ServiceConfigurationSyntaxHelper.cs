...
namespace CSIIOP
{
	public static class ServiceConfigurationSyntaxHelper
	{
		...
		public static CORBA.TypeCode Type()
		{
			if (type == null)
			{
				lock (typeof(ServiceConfigurationSyntaxHelper))
				{
					if (type == null)
					{
						type = CORBA.ORB.Init().CreateAliasTc(CSIIOP.ServiceConfigurationSyntaxHelper.Id(), "ServiceConfigurationSyntax", CORBA.ORB.Init().GetPrimitiveTc((CORBA.TCKind) 5));
					}
				}
			}
			return type;
		...
		{
			return "IDL:CSIIOP/ServiceConfigurationSyntax:1.0";
		}
