...
namespace DynamicAny
{
	...
	public class DynFixedLocalTie: _DynFixedLocalBase
	{
		public IDynFixedOperations _OperationsDelegate { get; set; }

		public DynFixedLocalTie(IDynFixedOperations d)
		{
		...
		{
			return _OperationsDelegate.GetValue();
		}
		[IdlName("set_value")]
		[ThrowsIdlException(typeof(DynamicAny.DynAny.TypeMismatch))]
		[ThrowsIdlException(typeof(DynamicAny.DynAny.InvalidValue))]
		public override bool SetValue([WideChar(false)] string val)
		{
			return _OperationsDelegate.SetValue(val);
		}
	}
}
