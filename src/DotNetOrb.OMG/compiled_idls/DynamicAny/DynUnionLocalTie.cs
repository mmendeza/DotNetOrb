...
namespace DynamicAny
{
	...
	public class DynUnionLocalTie: _DynUnionLocalBase
	{
		public IDynUnionOperations _OperationsDelegate { get; set; }

		public DynUnionLocalTie(IDynUnionOperations d)
		{
		...
		public override DynamicAny.IDynAny GetDiscriminator()
		{
			return _OperationsDelegate.GetDiscriminator();
		}
		[IdlName("set_discriminator")]
		[ThrowsIdlException(typeof(DynamicAny.DynAny.TypeMismatch))]
		public override void SetDiscriminator(DynamicAny.IDynAny d)
		{
			_OperationsDelegate.SetDiscriminator(d);
		}
		[IdlName("set_to_default_member")]
		[ThrowsIdlException(typeof(DynamicAny.DynAny.TypeMismatch))]
		public override void SetToDefaultMember()
		{
			_OperationsDelegate.SetToDefaultMember();
		}
		[IdlName("set_to_no_active_member")]
		[ThrowsIdlException(typeof(DynamicAny.DynAny.TypeMismatch))]
		public override void SetToNoActiveMember()
		{
			_OperationsDelegate.SetToNoActiveMember();
		}
		[IdlName("has_no_active_member")]
		public override bool HasNoActiveMember()
		{
			return _OperationsDelegate.HasNoActiveMember();
		}
		[IdlName("discriminator_kind")]
		public override CORBA.TCKind DiscriminatorKind()
		{
			return _OperationsDelegate.DiscriminatorKind();
		}
		[IdlName("member")]
		[ThrowsIdlException(typeof(DynamicAny.DynAny.InvalidValue))]
		public override DynamicAny.IDynAny Member()
		{
			return _OperationsDelegate.Member();
		}
		[IdlName("member_name")]
		[ThrowsIdlException(typeof(DynamicAny.DynAny.InvalidValue))]
		[return: WideChar(false)]
		...
		{
			return _OperationsDelegate.MemberName();
		}
		[IdlName("member_kind")]
		[ThrowsIdlException(typeof(DynamicAny.DynAny.InvalidValue))]
		public override CORBA.TCKind MemberKind()
		{
			return _OperationsDelegate.MemberKind();
		}
	}
}
