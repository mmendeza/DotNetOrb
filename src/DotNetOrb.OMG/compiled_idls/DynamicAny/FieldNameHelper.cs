...
namespace DynamicAny
{
	public static class FieldNameHelper
	{
		...
		public static CORBA.TypeCode Type()
		{
			if (type == null)
			{
				lock (typeof(FieldNameHelper))
				{
					if (type == null)
					{
						type = CORBA.ORB.Init().CreateAliasTc(DynamicAny.FieldNameHelper.Id(), "FieldName", CORBA.ORB.Init().CreateStringTc(0));
					}
				}
			}
			return type;
		...
		{
			return "IDL:DynamicAny/FieldName:1.0";
		}
