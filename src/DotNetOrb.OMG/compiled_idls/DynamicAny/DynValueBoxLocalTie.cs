...
namespace DynamicAny
{
	...
	public class DynValueBoxLocalTie: _DynValueBoxLocalBase
	{
		public IDynValueBoxOperations _OperationsDelegate { get; set; }

		public DynValueBoxLocalTie(IDynValueBoxOperations d)
		{
		...
		[ThrowsIdlException(typeof(DynamicAny.DynAny.InvalidValue))]
		public override CORBA.Any GetBoxedValue()
		{
			return _OperationsDelegate.GetBoxedValue();
		}
		[IdlName("set_boxed_value")]
		[ThrowsIdlException(typeof(DynamicAny.DynAny.TypeMismatch))]
		[ThrowsIdlException(typeof(DynamicAny.DynAny.InvalidValue))]
		public override void SetBoxedValue(CORBA.Any boxed)
		{
			_OperationsDelegate.SetBoxedValue(boxed);
		}
		[IdlName("get_boxed_value_as_dyn_any")]
		[ThrowsIdlException(typeof(DynamicAny.DynAny.InvalidValue))]
		public override DynamicAny.IDynAny GetBoxedValueAsDynAny()
		{
			return _OperationsDelegate.GetBoxedValueAsDynAny();
		}
		[IdlName("set_boxed_value_as_dyn_any")]
		[ThrowsIdlException(typeof(DynamicAny.DynAny.TypeMismatch))]
		public override void SetBoxedValueAsDynAny(DynamicAny.IDynAny boxed)
		{
			_OperationsDelegate.SetBoxedValueAsDynAny(boxed);
		}
	}
}
