...
{
	public abstract class _DynUnionLocalBase: CORBA.LocalObject, IDynUnion
	{
		private string[] _ids = {"IDL:DynamicAny/DynUnion:1.0","IDL:DynamicAny/DynAny:1.0"};
		...
		public abstract DynamicAny.IDynAny GetDiscriminator();
		[IdlName("set_discriminator")]
		[ThrowsIdlException(typeof(DynamicAny.DynAny.TypeMismatch))]
		public abstract void SetDiscriminator(DynamicAny.IDynAny d);
		[IdlName("set_to_default_member")]
		[ThrowsIdlException(typeof(DynamicAny.DynAny.TypeMismatch))]
		public abstract void SetToDefaultMember();
		[IdlName("set_to_no_active_member")]
		[ThrowsIdlException(typeof(DynamicAny.DynAny.TypeMismatch))]
		public abstract void SetToNoActiveMember();
		[IdlName("has_no_active_member")]
		public abstract bool HasNoActiveMember();
		[IdlName("discriminator_kind")]
		public abstract CORBA.TCKind DiscriminatorKind();
		[IdlName("member")]
		[ThrowsIdlException(typeof(DynamicAny.DynAny.InvalidValue))]
		public abstract DynamicAny.IDynAny Member();
		[IdlName("member_name")]
		[ThrowsIdlException(typeof(DynamicAny.DynAny.InvalidValue))]
		[return: WideChar(false)]
		...
		[IdlName("member_kind")]
		[ThrowsIdlException(typeof(DynamicAny.DynAny.InvalidValue))]
		public abstract CORBA.TCKind MemberKind();
	}
