...
namespace DynamicAny
{
	...
	public class DynStructLocalTie: _DynStructLocalBase
	{
		public IDynStructOperations _OperationsDelegate { get; set; }

		public DynStructLocalTie(IDynStructOperations d)
		{
