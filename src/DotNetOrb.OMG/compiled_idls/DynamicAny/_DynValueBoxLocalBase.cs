...
{
	public abstract class _DynValueBoxLocalBase: CORBA.LocalObject, IDynValueBox
	{
		private string[] _ids = {"IDL:DynamicAny/DynValueBox:1.0","IDL:DynamicAny/DynValueCommon:1.0"};
		...
		[ThrowsIdlException(typeof(DynamicAny.DynAny.InvalidValue))]
		public abstract CORBA.Any GetBoxedValue();
		[IdlName("set_boxed_value")]
		[ThrowsIdlException(typeof(DynamicAny.DynAny.TypeMismatch))]
		[ThrowsIdlException(typeof(DynamicAny.DynAny.InvalidValue))]
		public abstract void SetBoxedValue(CORBA.Any boxed);
		[IdlName("get_boxed_value_as_dyn_any")]
		[ThrowsIdlException(typeof(DynamicAny.DynAny.InvalidValue))]
		public abstract DynamicAny.IDynAny GetBoxedValueAsDynAny();
		[IdlName("set_boxed_value_as_dyn_any")]
		[ThrowsIdlException(typeof(DynamicAny.DynAny.TypeMismatch))]
		public abstract void SetBoxedValueAsDynAny(DynamicAny.IDynAny boxed);
	}
