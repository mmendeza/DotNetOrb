...
namespace DynamicAny
{
	...
	public class DynValueCommonLocalTie: _DynValueCommonLocalBase
	{
		public IDynValueCommonOperations _OperationsDelegate { get; set; }

		public DynValueCommonLocalTie(IDynValueCommonOperations d)
		{
