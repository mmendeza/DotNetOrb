...
{
	public static class BodyDataHelper
	{
		...
		public static CORBA.TypeCode Type()
		{
			if (type == null)
			{
				lock (typeof(BodyDataHelper))
				{
					if (type == null)
					{
						type = CORBA.ORB.Init().CreateAliasTc(MessageRouting.BodyDataHelper.Id(), "BodyData", CORBA.ORB.Init().CreateSequenceTc(0, CORBA.ORB.Init().GetPrimitiveTc((CORBA.TCKind) 10)));
					}
				}
			}
			return type;
		...
		{
			return "IDL:MessageRouting/BodyData:1.0";
		}
