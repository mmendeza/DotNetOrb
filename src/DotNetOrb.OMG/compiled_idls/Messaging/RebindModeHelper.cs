...
namespace Messaging
{
	public static class RebindModeHelper
	{
		...
		public static CORBA.TypeCode Type()
		{
			if (type == null)
			{
				lock (typeof(RebindModeHelper))
				{
					if (type == null)
					{
						type = CORBA.ORB.Init().CreateAliasTc(Messaging.RebindModeHelper.Id(), "RebindMode", CORBA.ORB.Init().GetPrimitiveTc((CORBA.TCKind) 4));
					}
				}
			}
			return type;
		...
		{
			return "IDL:Messaging/RebindMode:1.0";
		}
