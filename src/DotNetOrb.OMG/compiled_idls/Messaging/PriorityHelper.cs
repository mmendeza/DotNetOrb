...
namespace Messaging
{
	public static class PriorityHelper
	{
		...
		public static CORBA.TypeCode Type()
		{
			if (type == null)
			{
				lock (typeof(PriorityHelper))
				{
					if (type == null)
					{
						type = CORBA.ORB.Init().CreateAliasTc(Messaging.PriorityHelper.Id(), "Priority", CORBA.ORB.Init().GetPrimitiveTc((CORBA.TCKind) 4));
					}
				}
			}
			return type;
		...
		{
			return "IDL:Messaging/Priority:1.0";
		}
