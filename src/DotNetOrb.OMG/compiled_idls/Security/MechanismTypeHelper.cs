...
namespace Security
{
	public static class MechanismTypeHelper
	{
		...
		public static CORBA.TypeCode Type()
		{
			if (type == null)
			{
				lock (typeof(MechanismTypeHelper))
				{
					if (type == null)
					{
						type = CORBA.ORB.Init().CreateAliasTc(Security.MechanismTypeHelper.Id(), "MechanismType", CORBA.ORB.Init().CreateStringTc(0));
					}
				}
			}
			return type;
