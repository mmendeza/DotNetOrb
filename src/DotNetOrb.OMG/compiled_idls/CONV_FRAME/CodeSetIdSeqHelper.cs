...
{
	public static class CodeSetIdSeqHelper
	{
		...
		public static CORBA.TypeCode Type()
		{
			if (type == null)
			{
				lock (typeof(CodeSetIdSeqHelper))
				{
					if (type == null)
					{
						type = CORBA.ORB.Init().CreateAliasTc(CONV_FRAME.CodeSetIdSeqHelper.Id(), "CodeSetIdSeq", CORBA.ORB.Init().CreateSequenceTc(0, CORBA.ORB.Init().GetPrimitiveTc((CORBA.TCKind) 5)));
					}
				}
			}
			return type;
		...
		{
			return "IDL:CONV_FRAME/CodeSetIdSeq:1.0";
		}
