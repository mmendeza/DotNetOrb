...
namespace PortableInterceptor
{
	...
	public class ORBInitInfo31LocalTie: _ORBInitInfo31LocalBase
	{
		public IORBInitInfo31Operations _OperationsDelegate { get; set; }

		public ORBInitInfo31LocalTie(IORBInitInfo31Operations d)
		{
		...
		public override void AddClientRequestInterceptorWithPolicy(PortableInterceptor.IClientRequestInterceptor interceptor, CORBA.IPolicy[] policies)
		{
			_OperationsDelegate.AddClientRequestInterceptorWithPolicy(interceptor, policies);
		}
		[IdlName("add_server_request_interceptor_with_policy")]
		[ThrowsIdlException(typeof(PortableInterceptor.ORBInitInfo.DuplicateName))]
		[ThrowsIdlException(typeof(CORBA.PolicyError))]
		public override void AddServerRequestInterceptorWithPolicy(PortableInterceptor.IServerRequestInterceptor interceptor, CORBA.IPolicy[] policies)
		{
			_OperationsDelegate.AddServerRequestInterceptorWithPolicy(interceptor, policies);
		}
		[IdlName("add_ior_interceptor_with_policy")]
		[ThrowsIdlException(typeof(PortableInterceptor.ORBInitInfo.DuplicateName))]
		[ThrowsIdlException(typeof(CORBA.PolicyError))]
		public override void AddIorInterceptorWithPolicy(PortableInterceptor.IIORInterceptor interceptor, CORBA.IPolicy[] policies)
		{
			_OperationsDelegate.AddIorInterceptorWithPolicy(interceptor, policies);
		}
	}
}
