...
namespace PortableInterceptor
{
	public static class ObjectIdHelper
	{
		...
		public static CORBA.TypeCode Type()
		{
			if (type == null)
			{
				lock (typeof(ObjectIdHelper))
				{
					if (type == null)
					{
						type = CORBA.ORB.Init().CreateAliasTc(PortableInterceptor.ObjectIdHelper.Id(), "ObjectId", CORBA.ORB.Init().CreateSequenceTc(0, CORBA.ORB.Init().GetPrimitiveTc((CORBA.TCKind) 10)));
					}
				}
			}
			return type;
		...
		{
			return "IDL:PortableInterceptor/ObjectId:1.0";
		}
