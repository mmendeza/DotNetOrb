...
{
	public static class IORStringHelper
	{
		...
		public static CORBA.TypeCode Type()
		{
			if (type == null)
			{
				lock (typeof(IORStringHelper))
				{
					if (type == null)
					{
						type = CORBA.ORB.Init().CreateAliasTc(DotNetOrb.ImR.IORStringHelper.Id(), "IORString", CORBA.ORB.Init().CreateStringTc(0));
					}
				}
			}
			return type;
		...
		{
			return "IDL:DotNetOrb/ImR/IORString:1.0";
		}
