...
namespace CosNaming
{
	public class _BindingIteratorStub: CORBA.Object, IBindingIterator
	{
		private new string[] _ids = {"IDL:omg.org/CosNaming/BindingIterator:1.0"};
		...
		public static Type _opsType = typeof(IBindingIteratorOperations);
		...
		public bool NextOne(out CosNaming.Binding b)
		{
			while(true)
			{
				...
				try
				{
					outputStream = _Request("next_one", true);
					inputStream = _Invoke(outputStream);
					bool _result;
					_result = inputStream.ReadBoolean();
					b = CosNaming.BindingHelper.Read(inputStream);
					return _result;
				}
