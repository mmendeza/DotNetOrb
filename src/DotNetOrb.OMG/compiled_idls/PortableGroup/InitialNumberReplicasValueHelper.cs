...
{
	public static class InitialNumberReplicasValueHelper
	{
		...
		public static CORBA.TypeCode Type()
		{
			if (type == null)
			{
				lock (typeof(InitialNumberReplicasValueHelper))
				{
					if (type == null)
					{
						type = CORBA.ORB.Init().CreateAliasTc(PortableGroup.InitialNumberReplicasValueHelper.Id(), "InitialNumberReplicasValue", CORBA.ORB.Init().GetPrimitiveTc((CORBA.TCKind) 2));
					}
				}
			}
			return type;
