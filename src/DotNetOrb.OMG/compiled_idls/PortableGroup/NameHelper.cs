...
namespace PortableGroup
{
	public static class NameHelper
	{
		...
		public static CORBA.TypeCode Type()
		{
			if (type == null)
			{
				lock (typeof(NameHelper))
				{
					if (type == null)
					{
						type = CORBA.ORB.Init().CreateAliasTc(PortableGroup.NameHelper.Id(), "Name", CORBA.ORB.Init().CreateSequenceTc(0, CosNaming.NameComponentHelper.Type()));
					}
				}
			}
			return type;
