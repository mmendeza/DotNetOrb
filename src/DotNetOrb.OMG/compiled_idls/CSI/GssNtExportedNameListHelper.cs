...
namespace CSI
{
	public static class GssNtExportedNameListHelper
	{
		...
		public static CORBA.TypeCode Type()
		{
			if (type == null)
			{
				lock (typeof(GssNtExportedNameListHelper))
				{
					if (type == null)
					{
						type = CORBA.ORB.Init().CreateAliasTc(CSI.GssNtExportedNameListHelper.Id(), "GSS_NT_ExportedNameList", CORBA.ORB.Init().CreateSequenceTc(0, CORBA.ORB.Init().CreateSequenceTc(0, CORBA.ORB.Init().GetPrimitiveTc((CORBA.TCKind) 10))));
					}
				}
			}
			return type;
		...
		{
			return "IDL:CSI/GSS_NT_ExportedNameList:1.0";
		}
