...
namespace CSI
{
	public static class OIDListHelper
	{
		...
		public static CORBA.TypeCode Type()
		{
			if (type == null)
			{
				lock (typeof(OIDListHelper))
				{
					if (type == null)
					{
						type = CORBA.ORB.Init().CreateAliasTc(CSI.OIDListHelper.Id(), "OIDList", CORBA.ORB.Init().CreateSequenceTc(0, CORBA.ORB.Init().CreateSequenceTc(0, CORBA.ORB.Init().GetPrimitiveTc((CORBA.TCKind) 10))));
					}
				}
			}
			return type;
