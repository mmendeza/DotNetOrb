...
namespace GIOP
{
	public static class MsgType12Helper
	{
		...
		public static CORBA.TypeCode Type()
		{
			if (type == null)
			{
				lock (typeof(MsgType12Helper))
				{
					if (type == null)
					{
						type = CORBA.ORB.Init().CreateAliasTc(GIOP.MsgType12Helper.Id(), "MsgType_1_2", GIOP.MsgType11Helper.Type());
					}
				}
			}
			return type;
		...
		{
			return "IDL:GIOP/MsgType_1_2:1.0";
		}
