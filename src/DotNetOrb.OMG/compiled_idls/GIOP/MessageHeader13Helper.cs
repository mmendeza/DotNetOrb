...
namespace GIOP
{
	public static class MessageHeader13Helper
	{
		...
		public static CORBA.TypeCode Type()
		{
			if (type == null)
			{
				lock (typeof(MessageHeader13Helper))
				{
					if (type == null)
					{
						type = CORBA.ORB.Init().CreateAliasTc(GIOP.MessageHeader13Helper.Id(), "MessageHeader_1_3", GIOP.MessageHeader11Helper.Type());
					}
				}
			}
			return type;
		...
		{
			return "IDL:GIOP/MessageHeader_1_3:1.0";
		}
