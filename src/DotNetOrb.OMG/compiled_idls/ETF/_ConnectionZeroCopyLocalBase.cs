...
namespace ETF
{
	public abstract class _ConnectionZeroCopyLocalBase: CORBA.LocalObject, IConnectionZeroCopy
	{
		private string[] _ids = {"IDL:omg.org/ETF/ConnectionZeroCopy:1.0","IDL:omg.org/ETF/Connection:1.0"};
		...
		public abstract ETF.IBufferList CreateBufferList();
		[IdlName("write_zc")]
		public abstract void WriteZc(ref ETF.IBufferList data, ulong timeOut);
		[IdlName("read_zc")]
		public abstract void ReadZc(ref ETF.IBufferList data, uint minLength, ulong timeOut);
	}
