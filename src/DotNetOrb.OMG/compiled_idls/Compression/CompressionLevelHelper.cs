...
{
	public static class CompressionLevelHelper
	{
		...
		public static CORBA.TypeCode Type()
		{
			if (type == null)
			{
				lock (typeof(CompressionLevelHelper))
				{
					if (type == null)
					{
						type = CORBA.ORB.Init().CreateAliasTc(Compression.CompressionLevelHelper.Id(), "CompressionLevel", CORBA.ORB.Init().GetPrimitiveTc((CORBA.TCKind) 2));
					}
				}
			}
			return type;
