...
{
	public class _AdministrationStub: CORBA.Object, IAdministration
	{
		private new string[] _ids = {"IDL:ImplementationRepository/Administration:1.0"};
		...
		public static Type _opsType = typeof(IAdministrationOperations);
