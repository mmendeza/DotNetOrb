...
namespace CORBA
{
	...
	public class UnionDefPOATie: UnionDefPOA
	{
		public IUnionDefOperations _OperationsDelegate { get; set; }
		private PortableServer.IPOA _poa;

		public UnionDefPOATie(IUnionDefOperations d)
		{
			_OperationsDelegate = d;
		}

		public UnionDefPOATie(IUnionDefOperations d, PortableServer.POA poa)
		{
			_OperationsDelegate = d;
			_poa = poa;
		}
		...
		public override CORBA.IUnionDef _This()
		{
			return CORBA.UnionDefHelper.Narrow(_ThisObject());
		}

		public override CORBA.IUnionDef _This(CORBA.ORB orb)
		{
		...
		public override CORBA.TypeCode DiscriminatorType 
		{
			get
			{
				return _OperationsDelegate.DiscriminatorType;
			}
		}
		public override CORBA.IIDLType DiscriminatorTypeDef 
		{
			get
			{
				return _OperationsDelegate.DiscriminatorTypeDef;
			}

			set
			{
				_OperationsDelegate.DiscriminatorTypeDef = value;
			}
		}
		public override CORBA.UnionMember[] Members 
		{
			get
			{
