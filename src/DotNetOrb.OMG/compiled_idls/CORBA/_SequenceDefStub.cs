...
namespace CORBA
{
	public class _SequenceDefStub: CORBA.Object, ISequenceDef
	{
		private new string[] _ids = {"IDL:CORBA/SequenceDef:1.0","IDL:CORBA/IDLType:1.0"};
		...
		public static Type _opsType = typeof(ISequenceDefOperations);
				...
				{
					{
						...
						try
						{
							outputStream = _Request("_get_bound", true);
							inputStream = _Invoke(outputStream);
							uint _result;
				...
				{
					{
						...
						try
						{
							outputStream = _Request("_set_bound", true);
				...
				{
					{
						...
						try
						{
							outputStream = _Request("_get_element_type_def", true);
							inputStream = _Invoke(outputStream);
				...
				{
					{
						...
						try
						{
							outputStream = _Request("_set_element_type_def", true);
