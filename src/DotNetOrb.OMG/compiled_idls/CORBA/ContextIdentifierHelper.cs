...
namespace CORBA
{
	public static class ContextIdentifierHelper
	{
		...
		public static CORBA.TypeCode Type()
		{
			if (type == null)
			{
				lock (typeof(ContextIdentifierHelper))
				{
					if (type == null)
					{
						type = CORBA.ORB.Init().CreateAliasTc(CORBA.ContextIdentifierHelper.Id(), "ContextIdentifier", CORBA.ORB.Init().CreateStringTc(0));
					}
				}
			}
			return type;
		...
		{
			return "IDL:CORBA/ContextIdentifier:1.0";
		}
