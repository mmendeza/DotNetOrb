...
namespace CORBA
{
	...
	public class ValueDefPOATie: ValueDefPOA
	{
		public IValueDefOperations _OperationsDelegate { get; set; }
		private PortableServer.IPOA _poa;

		public ValueDefPOATie(IValueDefOperations d)
		{
			_OperationsDelegate = d;
		}

		public ValueDefPOATie(IValueDefOperations d, PortableServer.POA poa)
		{
			_OperationsDelegate = d;
			_poa = poa;
		}
		...
		public override CORBA.IValueDef _This()
		{
			return CORBA.ValueDefHelper.Narrow(_ThisObject());
		}

		public override CORBA.IValueDef _This(CORBA.ORB orb)
		{
