...
namespace CORBA
{
	...
	public class AttributeDefPOATie: AttributeDefPOA
	{
		public IAttributeDefOperations _OperationsDelegate { get; set; }
		private PortableServer.IPOA _poa;

		public AttributeDefPOATie(IAttributeDefOperations d)
		{
			_OperationsDelegate = d;
		}

		public AttributeDefPOATie(IAttributeDefOperations d, PortableServer.POA poa)
		{
			_OperationsDelegate = d;
			_poa = poa;
		}
		...
		public override CORBA.IAttributeDef _This()
		{
			return CORBA.AttributeDefHelper.Narrow(_ThisObject());
		}

		public override CORBA.IAttributeDef _This(CORBA.ORB orb)
		{
