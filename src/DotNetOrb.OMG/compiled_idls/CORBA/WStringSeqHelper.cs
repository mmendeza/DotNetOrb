...
namespace CORBA
{
	public static class WStringSeqHelper
	{
		...
		public static CORBA.TypeCode Type()
		{
			if (type == null)
			{
				lock (typeof(WStringSeqHelper))
				{
					if (type == null)
					{
						type = CORBA.ORB.Init().CreateAliasTc(CORBA.WStringSeqHelper.Id(), "WStringSeq", CORBA.ORB.Init().CreateSequenceTc(0, CORBA.ORB.Init().CreateStringTc(0)));
					}
				}
			}
			return type;
		...
		{
			return "IDL:CORBA/WStringSeq:1.0";
		}
