...
namespace CORBA
{
	public class _ContainerStub: CORBA.Object, IContainer
	{
		private new string[] _ids = {"IDL:CORBA/Container:1.0","IDL:CORBA/IRObject:1.0"};
		...
		public static Type _opsType = typeof(IContainerOperations);
