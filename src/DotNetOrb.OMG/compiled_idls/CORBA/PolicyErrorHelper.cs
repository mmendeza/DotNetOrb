		...
		public static CORBA.TypeCode Type()
		{
			if (type == null)
			{
				lock (typeof(PolicyErrorHelper))
				{
					if (type == null)
					{
						type = CORBA.ORB.Init().CreateExceptionTc(CORBA.PolicyErrorHelper.Id(), "PolicyError", new CORBA.StructMember[] {new CORBA.StructMember("reason", CORBA.ORB.Init().GetPrimitiveTc((CORBA.TCKind) 2), null), });
					}
				}
			}
			return type;
