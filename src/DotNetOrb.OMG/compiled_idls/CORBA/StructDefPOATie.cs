...
namespace CORBA
{
	...
	public class StructDefPOATie: StructDefPOA
	{
		public IStructDefOperations _OperationsDelegate { get; set; }
		private PortableServer.IPOA _poa;

		public StructDefPOATie(IStructDefOperations d)
		{
			_OperationsDelegate = d;
		}

		public StructDefPOATie(IStructDefOperations d, PortableServer.POA poa)
		{
			_OperationsDelegate = d;
			_poa = poa;
		}
		...
		public override CORBA.IStructDef _This()
		{
			return CORBA.StructDefHelper.Narrow(_ThisObject());
		}

		public override CORBA.IStructDef _This(CORBA.ORB orb)
		{
