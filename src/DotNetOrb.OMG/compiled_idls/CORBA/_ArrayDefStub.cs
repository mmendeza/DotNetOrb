...
namespace CORBA
{
	public class _ArrayDefStub: CORBA.Object, IArrayDef
	{
		private new string[] _ids = {"IDL:CORBA/ArrayDef:1.0","IDL:CORBA/IDLType:1.0"};
		...
		public static Type _opsType = typeof(IArrayDefOperations);
				...
				{
					{
						...
						try
						{
							outputStream = _Request("_get_length", true);
							inputStream = _Invoke(outputStream);
							uint _result;
				...
				{
					{
						...
						try
						{
							outputStream = _Request("_set_length", true);
