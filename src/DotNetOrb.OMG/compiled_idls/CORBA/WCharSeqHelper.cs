		...
		public static CORBA.TypeCode Type()
		{
			if (type == null)
			{
				lock (typeof(WCharSeqHelper))
				{
					if (type == null)
					{
						type = CORBA.ORB.Init().CreateAliasTc(CORBA.WCharSeqHelper.Id(), "WCharSeq", CORBA.ORB.Init().CreateSequenceTc(0, CORBA.ORB.Init().GetPrimitiveTc((CORBA.TCKind) 26)));
					}
				}
			}
			return type;
