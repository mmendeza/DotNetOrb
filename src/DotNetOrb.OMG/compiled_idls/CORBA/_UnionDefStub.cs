...
namespace CORBA
{
	public class _UnionDefStub: CORBA.Object, IUnionDef
	{
		private new string[] _ids = {"IDL:CORBA/UnionDef:1.0","IDL:CORBA/TypedefDef:1.0","IDL:CORBA/Container:1.0"};
		...
		public static Type _opsType = typeof(IUnionDefOperations);
				...
				{
					{
						...
						try
						{
							outputStream = _Request("_get_discriminator_type", true);
							inputStream = _Invoke(outputStream);
							CORBA.TypeCode _result;
							_result = inputStream.ReadTypeCode();
							return _result;
				...
				{
					{
						...
						try
						{
							outputStream = _Request("_get_discriminator_type_def", true);
							inputStream = _Invoke(outputStream);
				...
				{
					{
						...
						try
						{
							outputStream = _Request("_set_discriminator_type_def", true);
				...
				{
					{
						...
						try
						{
							...
							CORBA.UnionMember[] _result;
							{
								...
								_result = new CORBA.UnionMember[_capacity0];
