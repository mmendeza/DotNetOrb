...
namespace CORBA
{
	...
	public abstract class AttributeDefPOA: PortableServer.Servant, CORBA.IInvokeHandler, IAttributeDefOperations
	{
		static private Dictionary<string,int> _opsDict = new Dictionary<string,int>();
		static AttributeDefPOA()
		{
		...
		private string[] _ids = {"IDL:CORBA/AttributeDef:1.0","IDL:CORBA/Contained:1.0"};
		...
		public virtual CORBA.IAttributeDef _This()
		{
			return CORBA.AttributeDefHelper.Narrow(_ThisObject());
		}

		public virtual CORBA.IAttributeDef _This(CORBA.ORB orb)
		{
			return CORBA.AttributeDefHelper.Narrow(_ThisObject(orb));
		}
