...
namespace CORBA
{
	public class _NativeDefStub: CORBA.Object, INativeDef
	{
		private new string[] _ids = {"IDL:CORBA/NativeDef:1.0","IDL:CORBA/TypedefDef:1.0"};
		...
		public static Type _opsType = typeof(INativeDefOperations);
