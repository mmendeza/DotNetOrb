...
namespace CORBA
{
	...
	public abstract class TypedefDefPOA: PortableServer.Servant, CORBA.IInvokeHandler, ITypedefDefOperations
	{
		static private Dictionary<string,int> _opsDict = new Dictionary<string,int>();
		static TypedefDefPOA()
		{
		...
		private string[] _ids = {"IDL:CORBA/TypedefDef:1.0","IDL:CORBA/Contained:1.0","IDL:CORBA/IDLType:1.0"};
		...
		public virtual CORBA.ITypedefDef _This()
		{
			return CORBA.TypedefDefHelper.Narrow(_ThisObject());
		}

		public virtual CORBA.ITypedefDef _This(CORBA.ORB orb)
		{
