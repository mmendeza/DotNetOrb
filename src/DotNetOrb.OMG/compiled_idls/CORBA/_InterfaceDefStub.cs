...
namespace CORBA
{
	public class _InterfaceDefStub: CORBA.Object, IInterfaceDef
	{
		private new string[] _ids = {"IDL:CORBA/InterfaceDef:1.0","IDL:CORBA/Container:1.0","IDL:CORBA/Contained:1.0","IDL:CORBA/IDLType:1.0"};
		...
		public static Type _opsType = typeof(IInterfaceDefOperations);
