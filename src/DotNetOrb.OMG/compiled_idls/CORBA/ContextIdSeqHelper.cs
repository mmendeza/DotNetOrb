...
namespace CORBA
{
	public static class ContextIdSeqHelper
	{
		...
		public static CORBA.TypeCode Type()
		{
			if (type == null)
			{
				lock (typeof(ContextIdSeqHelper))
				{
					if (type == null)
					{
						type = CORBA.ORB.Init().CreateAliasTc(CORBA.ContextIdSeqHelper.Id(), "ContextIdSeq", CORBA.ORB.Init().CreateSequenceTc(0, CORBA.ORB.Init().CreateStringTc(0)));
					}
				}
			}
			return type;
		...
		{
			return "IDL:CORBA/ContextIdSeq:1.0";
		}
