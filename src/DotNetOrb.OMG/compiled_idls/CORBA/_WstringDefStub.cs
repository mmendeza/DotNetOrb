...
namespace CORBA
{
	public class _WstringDefStub: CORBA.Object, IWstringDef
	{
		private new string[] _ids = {"IDL:CORBA/WstringDef:1.0","IDL:CORBA/IDLType:1.0"};
		...
		public static Type _opsType = typeof(IWstringDefOperations);
