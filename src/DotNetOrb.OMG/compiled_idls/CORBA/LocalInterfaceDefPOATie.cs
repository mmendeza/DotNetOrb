...
namespace CORBA
{
	...
	public class LocalInterfaceDefPOATie: LocalInterfaceDefPOA
	{
		public ILocalInterfaceDefOperations _OperationsDelegate { get; set; }
		private PortableServer.IPOA _poa;

		public LocalInterfaceDefPOATie(ILocalInterfaceDefOperations d)
		{
			_OperationsDelegate = d;
		}

		public LocalInterfaceDefPOATie(ILocalInterfaceDefOperations d, PortableServer.POA poa)
		{
			_OperationsDelegate = d;
			_poa = poa;
		}
		...
		public override CORBA.ILocalInterfaceDef _This()
		{
			return CORBA.LocalInterfaceDefHelper.Narrow(_ThisObject());
		}

		public override CORBA.ILocalInterfaceDef _This(CORBA.ORB orb)
		{
