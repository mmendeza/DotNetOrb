...
namespace CORBA
{
	public static class PolicyTypeHelper
	{
		...
		public static CORBA.TypeCode Type()
		{
			if (type == null)
			{
				lock (typeof(PolicyTypeHelper))
				{
					if (type == null)
					{
						type = CORBA.ORB.Init().CreateAliasTc(CORBA.PolicyTypeHelper.Id(), "PolicyType", CORBA.ORB.Init().GetPrimitiveTc((CORBA.TCKind) 5));
					}
				}
			}
			return type;
		...
		{
			return "IDL:CORBA/PolicyType:1.0";
		}
