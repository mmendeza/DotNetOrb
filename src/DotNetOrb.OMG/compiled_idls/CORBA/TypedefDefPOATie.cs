...
namespace CORBA
{
	...
	public class TypedefDefPOATie: TypedefDefPOA
	{
		public ITypedefDefOperations _OperationsDelegate { get; set; }
		private PortableServer.IPOA _poa;

		public TypedefDefPOATie(ITypedefDefOperations d)
		{
			_OperationsDelegate = d;
		}

		public TypedefDefPOATie(ITypedefDefOperations d, PortableServer.POA poa)
		{
			_OperationsDelegate = d;
			_poa = poa;
		}
		...
		public override CORBA.ITypedefDef _This()
		{
			return CORBA.TypedefDefHelper.Narrow(_ThisObject());
		}

		public override CORBA.ITypedefDef _This(CORBA.ORB orb)
		{
			return CORBA.TypedefDefHelper.Narrow(_ThisObject(orb));
		}
