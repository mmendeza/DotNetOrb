...
namespace CORBA
{
	...
	public class ModuleDefPOATie: ModuleDefPOA
	{
		public IModuleDefOperations _OperationsDelegate { get; set; }
		private PortableServer.IPOA _poa;

		public ModuleDefPOATie(IModuleDefOperations d)
		{
			_OperationsDelegate = d;
		}

		public ModuleDefPOATie(IModuleDefOperations d, PortableServer.POA poa)
		{
			_OperationsDelegate = d;
			_poa = poa;
		}
		...
		public override CORBA.IModuleDef _This()
		{
			return CORBA.ModuleDefHelper.Narrow(_ThisObject());
		}

		public override CORBA.IModuleDef _This(CORBA.ORB orb)
		{
			return CORBA.ModuleDefHelper.Narrow(_ThisObject(orb));
		}
