...
namespace CORBA
{
	public class _ExtAbstractInterfaceDefStub: CORBA.Object, IExtAbstractInterfaceDef
	{
		private new string[] _ids = {"IDL:CORBA/ExtAbstractInterfaceDef:1.0","IDL:CORBA/AbstractInterfaceDef:1.0","IDL:CORBA/InterfaceAttrExtension:1.0"};
		...
		public static Type _opsType = typeof(IExtAbstractInterfaceDefOperations);
				...
				{
					{
						...
						try
						{
							outputStream = _Request("_get_base_interfaces", true);
							inputStream = _Invoke(outputStream);
				...
				{
					{
						...
						try
						{
							outputStream = _Request("_set_base_interfaces", true);
							{
		...
		public bool IsA([WideChar(false)] string interfaceId)
		{
			while(true)
			{
				...
				try
				{
					...
					outputStream.WriteString(interfaceId);
					inputStream = _Invoke(outputStream);
					bool _result;
					_result = inputStream.ReadBoolean();
					return _result;
		...
		public CORBA.InterfaceDef.FullInterfaceDescription DescribeInterface()
		{
			while(true)
			{
				...
				try
				{
					outputStream = _Request("describe_interface", true);
					inputStream = _Invoke(outputStream);
					CORBA.InterfaceDef.FullInterfaceDescription _result;
					_result = CORBA.InterfaceDef.FullInterfaceDescriptionHelper.Read(inputStream);
					return _result;
				}
				catch(RemarshalException)
				{
