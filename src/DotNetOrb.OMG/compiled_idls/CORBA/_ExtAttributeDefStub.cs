...
namespace CORBA
{
	public class _ExtAttributeDefStub: CORBA.Object, IExtAttributeDef
	{
		private new string[] _ids = {"IDL:CORBA/ExtAttributeDef:1.0","IDL:CORBA/AttributeDef:1.0"};
		...
		public static Type _opsType = typeof(IExtAttributeDefOperations);
				...
				{
					{
						...
						try
						{
							...
							_result = CORBA.AttributeModeHelper.Read(inputStream);
							return _result;
						}
						catch(RemarshalException)
						{
				...
				{
					{
						...
						try
						{
							...
							CORBA.AttributeModeHelper.Write(outputStream, value);
							inputStream = _Invoke(outputStream);
							return;
						}
						catch(RemarshalException)
				...
				{
					{
						...
						try
						{
							outputStream = _Request("_get_get_exceptions", true);
							inputStream = _Invoke(outputStream);
							CORBA.ExceptionDescription[] _result;
							{
								...
								_result = new CORBA.ExceptionDescription[_capacity0];
				...
				{
					{
						...
						try
						{
							outputStream = _Request("_set_get_exceptions", true);
							{
				...
				{
					{
						...
						try
						{
							outputStream = _Request("_get_set_exceptions", true);
							inputStream = _Invoke(outputStream);
							CORBA.ExceptionDescription[] _result;
							{
								var _capacity0 = inputStream.ReadLong();
				...
				{
					{
						...
						try
						{
							outputStream = _Request("_set_set_exceptions", true);
							{
								outputStream.WriteLong(value.Length);
								for (int i0 = 0; i0 < value.Length; i0++)
								{
		...
		public CORBA.ExtAttributeDescription DescribeAttribute()
		{
			while(true)
			{
				...
				try
				{
					outputStream = _Request("describe_attribute", true);
					inputStream = _Invoke(outputStream);
					CORBA.ExtAttributeDescription _result;
					_result = CORBA.ExtAttributeDescriptionHelper.Read(inputStream);
					return _result;
				}
				catch(RemarshalException)
				{
