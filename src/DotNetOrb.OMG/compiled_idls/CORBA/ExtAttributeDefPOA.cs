...
namespace CORBA
{
	...
	public abstract class ExtAttributeDefPOA: PortableServer.Servant, CORBA.IInvokeHandler, IExtAttributeDefOperations
	{
		static private Dictionary<string,int> _opsDict = new Dictionary<string,int>();
		static ExtAttributeDefPOA()
		{
			...
			_opsDict.Add("_set_mode", 16);
			_opsDict.Add("_get_mode", 17);
			_opsDict.Add("_set_get_exceptions", 18);
			_opsDict.Add("_get_get_exceptions", 19);
			_opsDict.Add("_set_set_exceptions", 20);
			_opsDict.Add("_get_set_exceptions", 21);
			_opsDict.Add("describe_attribute", 22);
		}
		private string[] _ids = {"IDL:CORBA/ExtAttributeDef:1.0","IDL:CORBA/AttributeDef:1.0"};
		...
		[IdlName("mode")]
		public abstract CORBA.AttributeMode Mode 
		{
			get;
		...
		public abstract CORBA.ExceptionDescription[] GetExceptions 
		{
			get;
		...
		public abstract CORBA.ExceptionDescription[] SetExceptions 
		{
			get;
		...
		public abstract CORBA.ExtAttributeDescription DescribeAttribute();
		...
		public virtual CORBA.IExtAttributeDef _This()
		{
			return CORBA.ExtAttributeDefHelper.Narrow(_ThisObject());
		}

		public virtual CORBA.IExtAttributeDef _This(CORBA.ORB orb)
		{
				...
				switch (opIndex)
				{
					...
					case 18:
					{
							outputStream = handler.CreateReply();
							{
								...
								GetExceptions = new CORBA.ExceptionDescription[_capacity0];
					...
					case 19:
					{
							outputStream = handler.CreateReply();
							{
								...
								{
									CORBA.ExceptionDescriptionHelper.Write(outputStream, GetExceptions[i0]);
								}
							}
					}
					break;
					case 20:
					{
							outputStream = handler.CreateReply();
							{
								...
								SetExceptions = new CORBA.ExceptionDescription[_capacity0];
								for (int i0 = 0; i0 < _capacity0; i0++)
								{
									CORBA.ExceptionDescription _item0;
									_item0 = CORBA.ExceptionDescriptionHelper.Read(inputStream);
					...
					case 21:
					{
							outputStream = handler.CreateReply();
							{
								...
								{
									CORBA.ExceptionDescriptionHelper.Write(outputStream, SetExceptions[i0]);
								}
							}
					}
					break;
					...
					{
							outputStream = handler.CreateReply();
							var _result = DescribeAttribute();
							CORBA.ExtAttributeDescriptionHelper.Write(outputStream, _result);
					}
					break;
				}
				return outputStream;
