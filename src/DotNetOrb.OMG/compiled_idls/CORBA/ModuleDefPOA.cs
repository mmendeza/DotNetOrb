...
namespace CORBA
{
	...
	public abstract class ModuleDefPOA: PortableServer.Servant, CORBA.IInvokeHandler, IModuleDefOperations
	{
		...
		private string[] _ids = {"IDL:CORBA/ModuleDef:1.0","IDL:CORBA/Container:1.0","IDL:CORBA/Contained:1.0"};
		...
		public virtual CORBA.IModuleDef _This()
		{
			return CORBA.ModuleDefHelper.Narrow(_ThisObject());
		}

		public virtual CORBA.IModuleDef _This(CORBA.ORB orb)
		{
