...
namespace CORBA
{
	public class _IDLTypeStub: CORBA.Object, IIDLType
	{
		private new string[] _ids = {"IDL:CORBA/IDLType:1.0","IDL:CORBA/IRObject:1.0"};
		...
		public static Type _opsType = typeof(IIDLTypeOperations);
