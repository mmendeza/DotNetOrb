...
namespace CORBA
{
	public class _ValueMemberDefStub: CORBA.Object, IValueMemberDef
	{
		private new string[] _ids = {"IDL:CORBA/ValueMemberDef:1.0","IDL:CORBA/Contained:1.0"};
		...
		public static Type _opsType = typeof(IValueMemberDefOperations);
				...
				{
					{
						...
						try
						{
							outputStream = _Request("_get_access", true);
							inputStream = _Invoke(outputStream);
							short _result;
				...
				{
					{
						...
						try
						{
							outputStream = _Request("_set_access", true);
