...
namespace CORBA
{
	public class _ValueBoxDefStub: CORBA.Object, IValueBoxDef
	{
		private new string[] _ids = {"IDL:CORBA/ValueBoxDef:1.0","IDL:CORBA/TypedefDef:1.0"};
		...
		public static Type _opsType = typeof(IValueBoxDefOperations);
