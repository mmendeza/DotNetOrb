...
namespace CORBA
{
    public class AbstractInterfaceTypeCode : ComplexTypeCode
    {        

        public AbstractInterfaceTypeCode(string id, string name) : base(TCKind.TkAbstractInterface, id, name)
        {            
        }
        ...
        public override TypeCode CompactTypeCode
        {
            get
            {
                ...
                var result = new AbstractInterfaceTypeCode(id, "");
                return result;
            }            
        }
        ...
        public static TypeCode ReadTypeCode(IInputStream inputStream, IDictionary<int,string> recursiveTCMap, IDictionary<int, TypeCode> repeatedTCMap,int startPosition)
        {
            ...
            if (result == null)
            {
                ...
                result = orb.CreateAbstractInterfaceTc(repositoryID, name);
