...
{
    public class ValueBaseType: BaseType
    {        
        public ValueBaseType(string name, bool dotNetNaming, List<Annotation> annotations = null) : base(name, dotNetNaming, annotations)
        {
