...
{
	public static class LogicalServerNameHelper
	{
		...
		public static CORBA.TypeCode Type()
		{
			if (type == null)
			{
				lock (typeof(LogicalServerNameHelper))
				{
					if (type == null)
					{
						type = CORBA.ORB.Init().CreateAliasTc(DotNetOrb.ImR.LogicalServerNameHelper.Id(), "LogicalServerName", CORBA.ORB.Init().CreateStringTc(0));
					}
				}
			}
			return type;
		...
		{
			return "IDL:DotNetOrb/ImR/LogicalServerName:1.0";
		}
