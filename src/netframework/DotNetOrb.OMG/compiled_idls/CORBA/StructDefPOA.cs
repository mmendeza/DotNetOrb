...
namespace CORBA
{
	...
	public abstract class StructDefPOA: PortableServer.Servant, CORBA.IInvokeHandler, IStructDefOperations
	{
		...
		private string[] _ids = {"IDL:CORBA/StructDef:1.0","IDL:CORBA/TypedefDef:1.0","IDL:CORBA/Container:1.0"};
		...
		public virtual CORBA.IStructDef _This()
		{
			return CORBA.StructDefHelper.Narrow(_ThisObject());
		}

		public virtual CORBA.IStructDef _This(CORBA.ORB orb)
		{
			return CORBA.StructDefHelper.Narrow(_ThisObject(orb));
		}
