...
namespace CORBA
{
	public static class ServiceDetailTypeHelper
	{
		...
		public static CORBA.TypeCode Type()
		{
			if (type == null)
			{
				lock (typeof(ServiceDetailTypeHelper))
				{
					if (type == null)
					{
						type = CORBA.ORB.Init().CreateAliasTc(CORBA.ServiceDetailTypeHelper.Id(), "ServiceDetailType", CORBA.ORB.Init().GetPrimitiveTc((CORBA.TCKind) 5));
					}
				}
			}
			return type;
		...
		{
			return "IDL:CORBA/ServiceDetailType:1.0";
		}
