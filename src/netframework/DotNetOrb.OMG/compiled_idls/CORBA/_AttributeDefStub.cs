...
namespace CORBA
{
	public class _AttributeDefStub: CORBA.Object, IAttributeDef
	{
		private new string[] _ids = {"IDL:CORBA/AttributeDef:1.0","IDL:CORBA/Contained:1.0"};
		...
		public static Type _opsType = typeof(IAttributeDefOperations);
