...
namespace CORBA
{
	public class _RepositoryStub: CORBA.Object, IRepository
	{
		private new string[] _ids = {"IDL:CORBA/Repository:1.0","IDL:CORBA/Container:1.0"};
		...
		public static Type _opsType = typeof(IRepositoryOperations);
		...
		public CORBA.IContained LookupId([WideChar(false)] string searchId)
		{
			while(true)
			{
				...
				try
				{
					outputStream = _Request("lookup_id", true);
					outputStream.WriteString(searchId);
					inputStream = _Invoke(outputStream);
					CORBA.IContained _result;
					_result = CORBA.ContainedHelper.Read(inputStream);
					return _result;
		...
		public CORBA.TypeCode GetCanonicalTypecode(CORBA.TypeCode tc)
		{
			while(true)
			{
				...
				try
				{
					outputStream = _Request("get_canonical_typecode", true);
					outputStream.WriteTypeCode(tc);
					inputStream = _Invoke(outputStream);
		...
		public CORBA.IPrimitiveDef GetPrimitive(CORBA.PrimitiveKind kind)
		{
			while(true)
			{
				...
				try
				{
					outputStream = _Request("get_primitive", true);
					CORBA.PrimitiveKindHelper.Write(outputStream, kind);
					inputStream = _Invoke(outputStream);
					CORBA.IPrimitiveDef _result;
					_result = CORBA.PrimitiveDefHelper.Read(inputStream);
					return _result;
				}
				catch(RemarshalException)
				{
		...
		public CORBA.IStringDef CreateString(uint bound)
		{
			while(true)
			{
				...
				try
				{
					outputStream = _Request("create_string", true);
					outputStream.WriteULong(bound);
					inputStream = _Invoke(outputStream);
					CORBA.IStringDef _result;
					_result = CORBA.StringDefHelper.Read(inputStream);
					return _result;
				}
				catch(RemarshalException)
				{
		...
		public CORBA.IWstringDef CreateWstring(uint bound)
		{
			while(true)
			{
				...
				try
				{
					outputStream = _Request("create_wstring", true);
					outputStream.WriteULong(bound);
					inputStream = _Invoke(outputStream);
					CORBA.IWstringDef _result;
					_result = CORBA.WstringDefHelper.Read(inputStream);
					return _result;
				}
				catch(RemarshalException)
				{
		...
		public CORBA.ISequenceDef CreateSequence(uint bound, CORBA.IIDLType elementType)
		{
			while(true)
			{
				...
				try
				{
					outputStream = _Request("create_sequence", true);
					outputStream.WriteULong(bound);
					CORBA.IDLTypeHelper.Write(outputStream, elementType);
					inputStream = _Invoke(outputStream);
					CORBA.ISequenceDef _result;
					_result = CORBA.SequenceDefHelper.Read(inputStream);
					return _result;
				}
				catch(RemarshalException)
				{
		...
		public CORBA.IArrayDef CreateArray(uint length, CORBA.IIDLType elementType)
		{
			while(true)
			{
				...
				try
				{
					outputStream = _Request("create_array", true);
					outputStream.WriteULong(length);
					CORBA.IDLTypeHelper.Write(outputStream, elementType);
					inputStream = _Invoke(outputStream);
					CORBA.IArrayDef _result;
					_result = CORBA.ArrayDefHelper.Read(inputStream);
					return _result;
				}
				catch(RemarshalException)
				{
		...
		public CORBA.IFixedDef CreateFixed(ushort digits, short scale)
		{
			while(true)
			{
				...
				try
				{
					outputStream = _Request("create_fixed", true);
					outputStream.WriteUShort(digits);
					outputStream.WriteShort(scale);
					inputStream = _Invoke(outputStream);
					CORBA.IFixedDef _result;
					_result = CORBA.FixedDefHelper.Read(inputStream);
					return _result;
				}
				catch(RemarshalException)
				{
