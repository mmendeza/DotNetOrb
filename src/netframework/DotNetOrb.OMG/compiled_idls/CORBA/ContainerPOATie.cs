...
namespace CORBA
{
	...
	public class ContainerPOATie: ContainerPOA
	{
		public IContainerOperations _OperationsDelegate { get; set; }
		private PortableServer.IPOA _poa;

		public ContainerPOATie(IContainerOperations d)
		{
			_OperationsDelegate = d;
		}

		public ContainerPOATie(IContainerOperations d, PortableServer.POA poa)
		{
			_OperationsDelegate = d;
			_poa = poa;
		}
		...
		public override CORBA.IContainer _This()
		{
			return CORBA.ContainerHelper.Narrow(_ThisObject());
		}

		public override CORBA.IContainer _This(CORBA.ORB orb)
		{
			return CORBA.ContainerHelper.Narrow(_ThisObject(orb));
		}
