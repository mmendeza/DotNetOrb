...
namespace CORBA
{
	public class _ExtInterfaceDefStub: CORBA.Object, IExtInterfaceDef
	{
		private new string[] _ids = {"IDL:CORBA/ExtInterfaceDef:1.0","IDL:CORBA/InterfaceDef:1.0","IDL:CORBA/InterfaceAttrExtension:1.0"};
		...
		public static Type _opsType = typeof(IExtInterfaceDefOperations);
