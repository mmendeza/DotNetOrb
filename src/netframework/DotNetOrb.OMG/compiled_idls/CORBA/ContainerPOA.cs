...
namespace CORBA
{
	...
	public abstract class ContainerPOA: PortableServer.Servant, CORBA.IInvokeHandler, IContainerOperations
	{
		...
		private string[] _ids = {"IDL:CORBA/Container:1.0","IDL:CORBA/IRObject:1.0"};
		...
		public virtual CORBA.IContainer _This()
		{
			return CORBA.ContainerHelper.Narrow(_ThisObject());
		}

		public virtual CORBA.IContainer _This(CORBA.ORB orb)
		{
