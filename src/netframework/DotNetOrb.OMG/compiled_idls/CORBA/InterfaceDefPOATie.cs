...
namespace CORBA
{
	...
	public class InterfaceDefPOATie: InterfaceDefPOA
	{
		public IInterfaceDefOperations _OperationsDelegate { get; set; }
		private PortableServer.IPOA _poa;

		public InterfaceDefPOATie(IInterfaceDefOperations d)
		{
			_OperationsDelegate = d;
		}

		public InterfaceDefPOATie(IInterfaceDefOperations d, PortableServer.POA poa)
		{
			_OperationsDelegate = d;
			_poa = poa;
		}
		...
		public override CORBA.IInterfaceDef _This()
		{
			return CORBA.InterfaceDefHelper.Narrow(_ThisObject());
		}

		public override CORBA.IInterfaceDef _This(CORBA.ORB orb)
		{
