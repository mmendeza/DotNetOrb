...
namespace CORBA
{
	public class _TypedefDefStub: CORBA.Object, ITypedefDef
	{
		private new string[] _ids = {"IDL:CORBA/TypedefDef:1.0","IDL:CORBA/Contained:1.0","IDL:CORBA/IDLType:1.0"};
		...
		public static Type _opsType = typeof(ITypedefDefOperations);
