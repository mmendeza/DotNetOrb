...
namespace CORBA
{
	...
	public class ExtInterfaceDefPOATie: ExtInterfaceDefPOA
	{
		public IExtInterfaceDefOperations _OperationsDelegate { get; set; }
		private PortableServer.IPOA _poa;

		public ExtInterfaceDefPOATie(IExtInterfaceDefOperations d)
		{
			_OperationsDelegate = d;
		}

		public ExtInterfaceDefPOATie(IExtInterfaceDefOperations d, PortableServer.POA poa)
		{
			_OperationsDelegate = d;
			_poa = poa;
		}
		...
		public override CORBA.IExtInterfaceDef _This()
		{
			return CORBA.ExtInterfaceDefHelper.Narrow(_ThisObject());
		}

		public override CORBA.IExtInterfaceDef _This(CORBA.ORB orb)
		{
			return CORBA.ExtInterfaceDefHelper.Narrow(_ThisObject(orb));
		}
