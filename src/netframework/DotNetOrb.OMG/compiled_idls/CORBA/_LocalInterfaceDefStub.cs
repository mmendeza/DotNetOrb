...
namespace CORBA
{
	public class _LocalInterfaceDefStub: CORBA.Object, ILocalInterfaceDef
	{
		private new string[] _ids = {"IDL:CORBA/LocalInterfaceDef:1.0","IDL:CORBA/InterfaceDef:1.0"};
		...
		public static Type _opsType = typeof(ILocalInterfaceDefOperations);
