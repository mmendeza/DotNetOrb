...
namespace CORBA
{
	public static class RepositoryIdSeqHelper
	{
		...
		public static CORBA.TypeCode Type()
		{
			if (type == null)
			{
				lock (typeof(RepositoryIdSeqHelper))
				{
					if (type == null)
					{
						type = CORBA.ORB.Init().CreateAliasTc(CORBA.RepositoryIdSeqHelper.Id(), "RepositoryIdSeq", CORBA.ORB.Init().CreateSequenceTc(0, CORBA.ORB.Init().CreateStringTc(0)));
					}
				}
			}
			return type;
		...
		{
			return "IDL:CORBA/RepositoryIdSeq:1.0";
		}
