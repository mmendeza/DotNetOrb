...
namespace CORBA
{
	...
	public abstract class UnionDefPOA: PortableServer.Servant, CORBA.IInvokeHandler, IUnionDefOperations
	{
		...
		static UnionDefPOA()
		{
			...
			_opsDict.Add("lookup", 14);
			_opsDict.Add("contents", 15);
			_opsDict.Add("lookup_name", 16);
			_opsDict.Add("describe_contents", 17);
			_opsDict.Add("create_module", 18);
			_opsDict.Add("create_constant", 19);
			_opsDict.Add("create_struct", 20);
			_opsDict.Add("create_union", 21);
			_opsDict.Add("create_enum", 22);
			_opsDict.Add("create_alias", 23);
			_opsDict.Add("create_interface", 24);
			_opsDict.Add("create_value", 25);
			_opsDict.Add("create_value_box", 26);
			_opsDict.Add("create_exception", 27);
			_opsDict.Add("create_native", 28);
			_opsDict.Add("create_abstract_interface", 29);
			_opsDict.Add("create_local_interface", 30);
			_opsDict.Add("create_ext_value", 31);
			_opsDict.Add("_get_discriminator_type", 32);
			_opsDict.Add("_set_discriminator_type_def", 33);
			_opsDict.Add("_get_discriminator_type_def", 34);
			_opsDict.Add("_set_members", 35);
			_opsDict.Add("_get_members", 36);
		}
		private string[] _ids = {"IDL:CORBA/UnionDef:1.0","IDL:CORBA/TypedefDef:1.0","IDL:CORBA/Container:1.0"};
		...
		public abstract CORBA.TypeCode DiscriminatorType 
		{
			get;
		}
		[IdlName("discriminator_type_def")]
		public abstract CORBA.IIDLType DiscriminatorTypeDef 
		{
			get;
		...
		[IdlName("members")]
		public abstract CORBA.UnionMember[] Members 
		{
			get;
		...
		public virtual CORBA.IUnionDef _This()
		{
			return CORBA.UnionDefHelper.Narrow(_ThisObject());
		}

		public virtual CORBA.IUnionDef _This(CORBA.ORB orb)
		{
			return CORBA.UnionDefHelper.Narrow(_ThisObject(orb));
		}
		...
		public CORBA.IOutputStream _Invoke(string method, CORBA.IInputStream inputStream, CORBA.IResponseHandler handler)
		{
			...
			if (_opsDict.TryGetValue(method, out opIndex))
			{
				switch (opIndex)
				{
					...
					{
							outputStream = handler.CreateReply();
							outputStream.WriteTypeCode(DiscriminatorType);
					}
					break;
					case 33:
					{
							outputStream = handler.CreateReply();
							DiscriminatorTypeDef = CORBA.IDLTypeHelper.Read(inputStream);
					}
					break;
					case 34:
					{
							outputStream = handler.CreateReply();
							CORBA.IDLTypeHelper.Write(outputStream, DiscriminatorTypeDef);
					}
					break;
					case 35:
					{
