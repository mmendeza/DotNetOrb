...
namespace CORBA
{
	...
	public abstract class ExtAbstractInterfaceDefPOA: PortableServer.Servant, CORBA.IInvokeHandler, IExtAbstractInterfaceDefOperations
	{
		static private Dictionary<string,int> _opsDict = new Dictionary<string,int>();
		static ExtAbstractInterfaceDefPOA()
		{
			...
			_opsDict.Add("describe_ext_interface", 40);
			_opsDict.Add("create_ext_attribute", 41);
		}
		private string[] _ids = {"IDL:CORBA/ExtAbstractInterfaceDef:1.0","IDL:CORBA/AbstractInterfaceDef:1.0","IDL:CORBA/InterfaceAttrExtension:1.0"};
		...
		public virtual CORBA.IExtAbstractInterfaceDef _This()
		{
			return CORBA.ExtAbstractInterfaceDefHelper.Narrow(_ThisObject());
		}

		public virtual CORBA.IExtAbstractInterfaceDef _This(CORBA.ORB orb)
		{
