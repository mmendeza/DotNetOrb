...
namespace CORBA
{
	...
	public abstract class ExtValueDefPOA: PortableServer.Servant, CORBA.IInvokeHandler, IExtValueDefOperations
	{
		static private Dictionary<string,int> _opsDict = new Dictionary<string,int>();
		static ExtValueDefPOA()
		{
			...
			_opsDict.Add("_set_ext_initializers", 51);
			_opsDict.Add("_get_ext_initializers", 52);
			_opsDict.Add("describe_ext_value", 53);
			_opsDict.Add("create_ext_attribute", 54);
		}
		private string[] _ids = {"IDL:CORBA/ExtValueDef:1.0","IDL:CORBA/ValueDef:1.0"};
		...
		public virtual CORBA.IExtValueDef _This()
		{
			return CORBA.ExtValueDefHelper.Narrow(_ThisObject());
		}

		public virtual CORBA.IExtValueDef _This(CORBA.ORB orb)
		{
				...
				switch (opIndex)
				{
					...
					case 51:
					{
							outputStream = handler.CreateReply();
							{
								...
								ExtInitializers = new CORBA.ExtInitializer[_capacity0];
								for (int i0 = 0; i0 < _capacity0; i0++)
								{
									CORBA.ExtInitializer _item0;
									_item0 = CORBA.ExtInitializerHelper.Read(inputStream);
									ExtInitializers[i0] = _item0;
								}
							}
					}
					break;
					case 52:
					{
							outputStream = handler.CreateReply();
							{
								outputStream.WriteLong(ExtInitializers.Length);
								for (int i0 = 0; i0 < ExtInitializers.Length; i0++)
								{
									CORBA.ExtInitializerHelper.Write(outputStream, ExtInitializers[i0]);
								}
							}
					}
					break;
					...
					{
							outputStream = handler.CreateReply();
							var _result = DescribeExtValue();
							CORBA.ExtValueDef.ExtFullValueDescriptionHelper.Write(outputStream, _result);
					}
					break;
					case 54:
					{
