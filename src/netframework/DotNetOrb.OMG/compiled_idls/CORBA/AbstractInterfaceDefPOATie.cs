...
namespace CORBA
{
	...
	public class AbstractInterfaceDefPOATie: AbstractInterfaceDefPOA
	{
		public IAbstractInterfaceDefOperations _OperationsDelegate { get; set; }
		private PortableServer.IPOA _poa;

		public AbstractInterfaceDefPOATie(IAbstractInterfaceDefOperations d)
		{
			_OperationsDelegate = d;
		}

		public AbstractInterfaceDefPOATie(IAbstractInterfaceDefOperations d, PortableServer.POA poa)
		{
			_OperationsDelegate = d;
			_poa = poa;
		}
		...
		public override CORBA.IAbstractInterfaceDef _This()
		{
			return CORBA.AbstractInterfaceDefHelper.Narrow(_ThisObject());
		}

		public override CORBA.IAbstractInterfaceDef _This(CORBA.ORB orb)
		{
