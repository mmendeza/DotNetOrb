...
namespace CORBA
{
	...
	public abstract class ExtInterfaceDefPOA: PortableServer.Servant, CORBA.IInvokeHandler, IExtInterfaceDefOperations
	{
		static private Dictionary<string,int> _opsDict = new Dictionary<string,int>();
		static ExtInterfaceDefPOA()
		{
		...
		private string[] _ids = {"IDL:CORBA/ExtInterfaceDef:1.0","IDL:CORBA/InterfaceDef:1.0","IDL:CORBA/InterfaceAttrExtension:1.0"};
		...
		public virtual CORBA.IExtInterfaceDef _This()
		{
			return CORBA.ExtInterfaceDefHelper.Narrow(_ThisObject());
		}

		public virtual CORBA.IExtInterfaceDef _This(CORBA.ORB orb)
		{
