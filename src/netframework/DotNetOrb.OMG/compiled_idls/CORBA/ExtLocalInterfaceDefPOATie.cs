...
namespace CORBA
{
	...
	public class ExtLocalInterfaceDefPOATie: ExtLocalInterfaceDefPOA
	{
		public IExtLocalInterfaceDefOperations _OperationsDelegate { get; set; }
		private PortableServer.IPOA _poa;

		public ExtLocalInterfaceDefPOATie(IExtLocalInterfaceDefOperations d)
		{
			_OperationsDelegate = d;
		}

		public ExtLocalInterfaceDefPOATie(IExtLocalInterfaceDefOperations d, PortableServer.POA poa)
		{
			_OperationsDelegate = d;
			_poa = poa;
		}
		...
		public override CORBA.IExtLocalInterfaceDef _This()
		{
			return CORBA.ExtLocalInterfaceDefHelper.Narrow(_ThisObject());
		}

		public override CORBA.IExtLocalInterfaceDef _This(CORBA.ORB orb)
		{
			return CORBA.ExtLocalInterfaceDefHelper.Narrow(_ThisObject(orb));
		}
