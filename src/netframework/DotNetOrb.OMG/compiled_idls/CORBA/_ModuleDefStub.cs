...
namespace CORBA
{
	public class _ModuleDefStub: CORBA.Object, IModuleDef
	{
		private new string[] _ids = {"IDL:CORBA/ModuleDef:1.0","IDL:CORBA/Container:1.0","IDL:CORBA/Contained:1.0"};
		...
		public static Type _opsType = typeof(IModuleDefOperations);
