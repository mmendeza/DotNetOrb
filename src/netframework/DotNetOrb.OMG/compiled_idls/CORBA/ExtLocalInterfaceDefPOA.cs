...
namespace CORBA
{
	...
	public abstract class ExtLocalInterfaceDefPOA: PortableServer.Servant, CORBA.IInvokeHandler, IExtLocalInterfaceDefOperations
	{
		static private Dictionary<string,int> _opsDict = new Dictionary<string,int>();
		static ExtLocalInterfaceDefPOA()
		{
		...
		private string[] _ids = {"IDL:CORBA/ExtLocalInterfaceDef:1.0","IDL:CORBA/LocalInterfaceDef:1.0","IDL:CORBA/InterfaceAttrExtension:1.0"};
		...
		public virtual CORBA.IExtLocalInterfaceDef _This()
		{
			return CORBA.ExtLocalInterfaceDefHelper.Narrow(_ThisObject());
		}

		public virtual CORBA.IExtLocalInterfaceDef _This(CORBA.ORB orb)
		{
