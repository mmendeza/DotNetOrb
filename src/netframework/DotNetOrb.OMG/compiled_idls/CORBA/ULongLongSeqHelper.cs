...
namespace CORBA
{
	public static class ULongLongSeqHelper
	{
		...
		public static CORBA.TypeCode Type()
		{
			if (type == null)
			{
				lock (typeof(ULongLongSeqHelper))
				{
					if (type == null)
					{
						type = CORBA.ORB.Init().CreateAliasTc(CORBA.ULongLongSeqHelper.Id(), "ULongLongSeq", CORBA.ORB.Init().CreateSequenceTc(0, CORBA.ORB.Init().GetPrimitiveTc((CORBA.TCKind) 24)));
					}
				}
			}
			return type;
		...
		{
			return "IDL:CORBA/ULongLongSeq:1.0";
		}
