...
namespace CORBA
{
	public static class VersionSpecHelper
	{
		...
		public static CORBA.TypeCode Type()
		{
			if (type == null)
			{
				lock (typeof(VersionSpecHelper))
				{
					if (type == null)
					{
						type = CORBA.ORB.Init().CreateAliasTc(CORBA.VersionSpecHelper.Id(), "VersionSpec", CORBA.ORB.Init().CreateStringTc(0));
					}
				}
			}
			return type;
		...
		{
			return "IDL:CORBA/VersionSpec:1.0";
		}
