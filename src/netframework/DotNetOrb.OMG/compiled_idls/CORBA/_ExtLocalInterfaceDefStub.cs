...
namespace CORBA
{
	public class _ExtLocalInterfaceDefStub: CORBA.Object, IExtLocalInterfaceDef
	{
		private new string[] _ids = {"IDL:CORBA/ExtLocalInterfaceDef:1.0","IDL:CORBA/LocalInterfaceDef:1.0","IDL:CORBA/InterfaceAttrExtension:1.0"};
		...
		public static Type _opsType = typeof(IExtLocalInterfaceDefOperations);
