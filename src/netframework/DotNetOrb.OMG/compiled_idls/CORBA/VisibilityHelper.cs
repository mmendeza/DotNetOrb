...
namespace CORBA
{
	public static class VisibilityHelper
	{
		...
		public static CORBA.TypeCode Type()
		{
			if (type == null)
			{
				lock (typeof(VisibilityHelper))
				{
					if (type == null)
					{
						type = CORBA.ORB.Init().CreateAliasTc(CORBA.VisibilityHelper.Id(), "Visibility", CORBA.ORB.Init().GetPrimitiveTc((CORBA.TCKind) 2));
					}
				}
			}
			return type;
		...
		{
			return "IDL:CORBA/Visibility:1.0";
		}
