...
namespace CORBA
{
	...
	public abstract class ValueMemberDefPOA: PortableServer.Servant, CORBA.IInvokeHandler, IValueMemberDefOperations
	{
		static private Dictionary<string,int> _opsDict = new Dictionary<string,int>();
		static ValueMemberDefPOA()
		{
			...
			_opsDict.Add("_set_access", 16);
			_opsDict.Add("_get_access", 17);
		}
		private string[] _ids = {"IDL:CORBA/ValueMemberDef:1.0","IDL:CORBA/Contained:1.0"};
		...
		public virtual CORBA.IValueMemberDef _This()
		{
			return CORBA.ValueMemberDefHelper.Narrow(_ThisObject());
		}

		public virtual CORBA.IValueMemberDef _This(CORBA.ORB orb)
		{
			return CORBA.ValueMemberDefHelper.Narrow(_ThisObject(orb));
		}
