		...
		public static CORBA.TypeCode Type()
		{
			if (type == null)
			{
				lock (typeof(OctetSeqHelper))
				{
					if (type == null)
					{
						type = CORBA.ORB.Init().CreateAliasTc(CORBA.OctetSeqHelper.Id(), "OctetSeq", CORBA.ORB.Init().CreateSequenceTc(0, CORBA.ORB.Init().GetPrimitiveTc((CORBA.TCKind) 10)));
					}
				}
			}
			return type;
