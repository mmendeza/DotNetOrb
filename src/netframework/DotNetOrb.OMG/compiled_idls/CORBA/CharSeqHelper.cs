		...
		public static CORBA.TypeCode Type()
		{
			if (type == null)
			{
				lock (typeof(CharSeqHelper))
				{
					if (type == null)
					{
						type = CORBA.ORB.Init().CreateAliasTc(CORBA.CharSeqHelper.Id(), "CharSeq", CORBA.ORB.Init().CreateSequenceTc(0, CORBA.ORB.Init().GetPrimitiveTc((CORBA.TCKind) 9)));
					}
				}
			}
			return type;
