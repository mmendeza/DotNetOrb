...
namespace CORBA
{
	...
	public abstract class NativeDefPOA: PortableServer.Servant, CORBA.IInvokeHandler, INativeDefOperations
	{
		...
		private string[] _ids = {"IDL:CORBA/NativeDef:1.0","IDL:CORBA/TypedefDef:1.0"};
		...
		public virtual CORBA.INativeDef _This()
		{
			return CORBA.NativeDefHelper.Narrow(_ThisObject());
		}

		public virtual CORBA.INativeDef _This(CORBA.ORB orb)
		{
