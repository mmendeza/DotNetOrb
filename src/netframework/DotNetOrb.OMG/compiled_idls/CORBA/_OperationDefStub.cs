...
namespace CORBA
{
	public class _OperationDefStub: CORBA.Object, IOperationDef
	{
		private new string[] _ids = {"IDL:CORBA/OperationDef:1.0","IDL:CORBA/Contained:1.0"};
		...
		public static Type _opsType = typeof(IOperationDefOperations);
				...
				{
					{
						...
						try
						{
							outputStream = _Request("_get_result", true);
							inputStream = _Invoke(outputStream);
				...
				{
					{
						...
						try
						{
							outputStream = _Request("_get_result_def", true);
							inputStream = _Invoke(outputStream);
				...
				{
					{
						...
						try
						{
							outputStream = _Request("_set_result_def", true);
				...
				{
					{
						...
						try
						{
							outputStream = _Request("_get_params", true);
							inputStream = _Invoke(outputStream);
							CORBA.ParameterDescription[] _result;
							{
								...
								_result = new CORBA.ParameterDescription[_capacity0];
				...
				{
					{
						...
						try
						{
							outputStream = _Request("_set_params", true);
							{
				...
				{
					{
						...
						try
						{
							outputStream = _Request("_get_mode", true);
							inputStream = _Invoke(outputStream);
							CORBA.OperationMode _result;
							_result = CORBA.OperationModeHelper.Read(inputStream);
							return _result;
						}
						catch(RemarshalException)
						{
				...
				{
					{
						...
						try
						{
							outputStream = _Request("_set_mode", true);
							CORBA.OperationModeHelper.Write(outputStream, value);
							inputStream = _Invoke(outputStream);
							return;
						}
						catch(RemarshalException)
				...
				{
					{
						...
						try
						{
							outputStream = _Request("_get_contexts", true);
							inputStream = _Invoke(outputStream);
							string[] _result;
							{
								var _capacity0 = inputStream.ReadLong();
				...
				{
					{
						...
						try
						{
							outputStream = _Request("_set_contexts", true);
							{
								outputStream.WriteLong(value.Length);
								for (int i0 = 0; i0 < value.Length; i0++)
								{
				...
				{
					{
						...
						try
						{
							outputStream = _Request("_get_exceptions", true);
							inputStream = _Invoke(outputStream);
							CORBA.IExceptionDef[] _result;
							{
								...
								_result = new CORBA.IExceptionDef[_capacity0];
								for (int i0 = 0; i0 < _capacity0; i0++)
								{
				...
				{
					{
						...
						try
						{
							outputStream = _Request("_set_exceptions", true);
							{
								outputStream.WriteLong(value.Length);
								for (int i0 = 0; i0 < value.Length; i0++)
								{
