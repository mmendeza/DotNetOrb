...
namespace CORBA
{
	public abstract partial class ExtValueDef : CORBA.Object, CORBA.IExtValueDef
	{
		[RepositoryID("IDL:CORBA/ExtValueDef/ExtFullValueDescription:1.0")]
		[Helper(typeof(ExtFullValueDescriptionHelper))]
		public partial class ExtFullValueDescription: CORBA.IIDLEntity, IEquatable<CORBA.ExtValueDef.ExtFullValueDescription>
		{
			[IdlName("ExtFullValueDescription")]
			[WideChar(false)]
			...
			[IdlName("ExtFullValueDescription")]
			public CORBA.ExtInitializer[] Initializers { get; set; }
			[IdlName("ExtFullValueDescription")]
			...
			public ExtFullValueDescription(ExtFullValueDescription other)
			{
				Name = other.Name;
				Id = other.Id;
			...
			public ExtFullValueDescription(string name, string id, bool isAbstract, bool isCustom, string definedIn, string version, CORBA.OperationDescription[] operations, CORBA.ExtAttributeDescription[] attributes, CORBA.ValueMember[] members, CORBA.ExtInitializer[] initializers, string[] supportedInterfaces, string[] abstractBaseValues, bool isTruncatable, string baseValue, CORBA.TypeCode type)
			{
				this.Name = name;
				this.Id = id;
			...
			public bool Equals(CORBA.ExtValueDef.ExtFullValueDescription? other)
			{
		...
		public static class ExtFullValueDescriptionHelper
		{
			...
			public static CORBA.TypeCode Type()
			{
				if (type == null)
				{
					lock (typeof(ExtFullValueDescriptionHelper))
					{
						if (type == null)
						{
							type = CORBA.ORB.Init().CreateStructTc(CORBA.ExtValueDef.ExtFullValueDescriptionHelper.Id(), "ExtFullValueDescription", new CORBA.StructMember[] {new CORBA.StructMember("name", CORBA.ORB.Init().CreateStringTc(0), null), new CORBA.StructMember("id", CORBA.ORB.Init().CreateStringTc(0), null), new CORBA.StructMember("is_abstract", CORBA.ORB.Init().GetPrimitiveTc((CORBA.TCKind) 8), null), new CORBA.StructMember("is_custom", CORBA.ORB.Init().GetPrimitiveTc((CORBA.TCKind) 8), null), new CORBA.StructMember("defined_in", CORBA.ORB.Init().CreateStringTc(0), null), new CORBA.StructMember("version", CORBA.ORB.Init().CreateStringTc(0), null), new CORBA.StructMember("operations", CORBA.ORB.Init().CreateSequenceTc(0, CORBA.OperationDescriptionHelper.Type()), null), new CORBA.StructMember("attributes", CORBA.ORB.Init().CreateSequenceTc(0, CORBA.ExtAttributeDescriptionHelper.Type()), null), new CORBA.StructMember("members", CORBA.ORB.Init().CreateSequenceTc(0, CORBA.ValueMemberHelper.Type()), null), new CORBA.StructMember("initializers", CORBA.ORB.Init().CreateSequenceTc(0, CORBA.ExtInitializerHelper.Type()), null), new CORBA.StructMember("supported_interfaces", CORBA.ORB.Init().CreateSequenceTc(0, CORBA.ORB.Init().CreateStringTc(0)), null), new CORBA.StructMember("abstract_base_values", CORBA.ORB.Init().CreateSequenceTc(0, CORBA.ORB.Init().CreateStringTc(0)), null), new CORBA.StructMember("is_truncatable", CORBA.ORB.Init().GetPrimitiveTc((CORBA.TCKind) 8), null), new CORBA.StructMember("base_value", CORBA.ORB.Init().CreateStringTc(0), null), new CORBA.StructMember("type", CORBA.ORB.Init().GetPrimitiveTc((CORBA.TCKind) 12), null), });
						}
					}
				}
				return type;
			...
			public static void Insert(CORBA.Any any, CORBA.ExtValueDef.ExtFullValueDescription s)
			{
				any.Type = Type();
				Write(any.CreateOutputStream(), s);
			}

			public static CORBA.ExtValueDef.ExtFullValueDescription Extract(CORBA.Any any)
			{
			...
			{
				return "IDL:CORBA/ExtValueDef/ExtFullValueDescription:1.0";
			}

			public static CORBA.ExtValueDef.ExtFullValueDescription Read(CORBA.IInputStream inputStream)
			{
				var result = new CORBA.ExtValueDef.ExtFullValueDescription();
				...
				}
				{
					...
					result.Initializers = new CORBA.ExtInitializer[_capacity0];
					for (int i0 = 0; i0 < _capacity0; i0++)
					{
			...
			public static void Write(CORBA.IOutputStream outputStream, CORBA.ExtValueDef.ExtFullValueDescription s)
			{
				...
				}
				{
					...
					{
						CORBA.ExtInitializerHelper.Write(outputStream, s.Initializers[i0]);
					}
				}
				{
		...
		public abstract CORBA.ExtInitializer[] ExtInitializers 
		{
			get;
		...
		public abstract CORBA.ExtValueDef.ExtFullValueDescription DescribeExtValue();
