...
namespace CORBA
{
	...
	public abstract class InterfaceDefPOA: PortableServer.Servant, CORBA.IInvokeHandler, IInterfaceDefOperations
	{
		static private Dictionary<string,int> _opsDict = new Dictionary<string,int>();
		static InterfaceDefPOA()
		{
		...
		private string[] _ids = {"IDL:CORBA/InterfaceDef:1.0","IDL:CORBA/Container:1.0","IDL:CORBA/Contained:1.0","IDL:CORBA/IDLType:1.0"};
		...
		public virtual CORBA.IInterfaceDef _This()
		{
			return CORBA.InterfaceDefHelper.Narrow(_ThisObject());
		}

		public virtual CORBA.IInterfaceDef _This(CORBA.ORB orb)
		{
			return CORBA.InterfaceDefHelper.Narrow(_ThisObject(orb));
		}
