...
namespace CORBA
{
	...
	public class ExceptionDefPOATie: ExceptionDefPOA
	{
		public IExceptionDefOperations _OperationsDelegate { get; set; }
		private PortableServer.IPOA _poa;

		public ExceptionDefPOATie(IExceptionDefOperations d)
		{
			_OperationsDelegate = d;
		}

		public ExceptionDefPOATie(IExceptionDefOperations d, PortableServer.POA poa)
		{
			_OperationsDelegate = d;
			_poa = poa;
		}
		...
		public override CORBA.IExceptionDef _This()
		{
			return CORBA.ExceptionDefHelper.Narrow(_ThisObject());
		}

		public override CORBA.IExceptionDef _This(CORBA.ORB orb)
		{
		...
		public override CORBA.StructMember[] Members 
		{
			get
			{
