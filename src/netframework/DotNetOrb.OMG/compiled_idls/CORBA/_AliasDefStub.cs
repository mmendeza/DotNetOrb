...
namespace CORBA
{
	public class _AliasDefStub: CORBA.Object, IAliasDef
	{
		private new string[] _ids = {"IDL:CORBA/AliasDef:1.0","IDL:CORBA/TypedefDef:1.0"};
		...
		public static Type _opsType = typeof(IAliasDefOperations);
