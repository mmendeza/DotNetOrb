...
namespace CORBA
{
	...
	public class ValueMemberDefPOATie: ValueMemberDefPOA
	{
		public IValueMemberDefOperations _OperationsDelegate { get; set; }
		private PortableServer.IPOA _poa;

		public ValueMemberDefPOATie(IValueMemberDefOperations d)
		{
			_OperationsDelegate = d;
		}

		public ValueMemberDefPOATie(IValueMemberDefOperations d, PortableServer.POA poa)
		{
			_OperationsDelegate = d;
			_poa = poa;
		}
		...
		public override CORBA.IValueMemberDef _This()
		{
			return CORBA.ValueMemberDefHelper.Narrow(_ThisObject());
		}

		public override CORBA.IValueMemberDef _This(CORBA.ORB orb)
		{
		...
		public override short Access 
		{
			get
			{
				return _OperationsDelegate.Access;
			}

			set
			{
				_OperationsDelegate.Access = value;
			}
		}
	}
}
