...
namespace CORBA
{
	public class _ValueDefStub: CORBA.Object, IValueDef
	{
		private new string[] _ids = {"IDL:CORBA/ValueDef:1.0","IDL:CORBA/Container:1.0","IDL:CORBA/Contained:1.0","IDL:CORBA/IDLType:1.0"};
		...
		public static Type _opsType = typeof(IValueDefOperations);
