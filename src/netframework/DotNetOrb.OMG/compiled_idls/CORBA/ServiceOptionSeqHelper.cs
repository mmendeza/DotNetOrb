...
namespace CORBA
{
	public static class ServiceOptionSeqHelper
	{
		...
		public static CORBA.TypeCode Type()
		{
			if (type == null)
			{
				lock (typeof(ServiceOptionSeqHelper))
				{
					if (type == null)
					{
						type = CORBA.ORB.Init().CreateAliasTc(CORBA.ServiceOptionSeqHelper.Id(), "ServiceOptionSeq", CORBA.ORB.Init().CreateSequenceTc(0, CORBA.ORB.Init().GetPrimitiveTc((CORBA.TCKind) 5)));
					}
				}
			}
			return type;
		...
		{
			return "IDL:CORBA/ServiceOptionSeq:1.0";
		}
