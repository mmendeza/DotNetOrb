...
namespace CORBA
{
	public class _StringDefStub: CORBA.Object, IStringDef
	{
		private new string[] _ids = {"IDL:CORBA/StringDef:1.0","IDL:CORBA/IDLType:1.0"};
		...
		public static Type _opsType = typeof(IStringDefOperations);
