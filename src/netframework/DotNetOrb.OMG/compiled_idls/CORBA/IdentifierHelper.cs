...
namespace CORBA
{
	public static class IdentifierHelper
	{
		...
		public static CORBA.TypeCode Type()
		{
			if (type == null)
			{
				lock (typeof(IdentifierHelper))
				{
					if (type == null)
					{
						type = CORBA.ORB.Init().CreateAliasTc(CORBA.IdentifierHelper.Id(), "Identifier", CORBA.ORB.Init().CreateStringTc(0));
					}
				}
			}
			return type;
		...
		{
			return "IDL:CORBA/Identifier:1.0";
		}
