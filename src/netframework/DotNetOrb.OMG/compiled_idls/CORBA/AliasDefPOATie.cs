...
namespace CORBA
{
	...
	public class AliasDefPOATie: AliasDefPOA
	{
		public IAliasDefOperations _OperationsDelegate { get; set; }
		private PortableServer.IPOA _poa;

		public AliasDefPOATie(IAliasDefOperations d)
		{
			_OperationsDelegate = d;
		}

		public AliasDefPOATie(IAliasDefOperations d, PortableServer.POA poa)
		{
			_OperationsDelegate = d;
			_poa = poa;
		}
		...
		public override CORBA.IAliasDef _This()
		{
			return CORBA.AliasDefHelper.Narrow(_ThisObject());
		}

		public override CORBA.IAliasDef _This(CORBA.ORB orb)
		{
