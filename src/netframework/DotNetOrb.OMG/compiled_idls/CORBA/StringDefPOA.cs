...
namespace CORBA
{
	...
	public abstract class StringDefPOA: PortableServer.Servant, CORBA.IInvokeHandler, IStringDefOperations
	{
		...
		private string[] _ids = {"IDL:CORBA/StringDef:1.0","IDL:CORBA/IDLType:1.0"};
		...
		public virtual CORBA.IStringDef _This()
		{
			return CORBA.StringDefHelper.Narrow(_ThisObject());
		}

		public virtual CORBA.IStringDef _This(CORBA.ORB orb)
		{
