...
namespace CORBA
{
	...
	public abstract class ExceptionDefPOA: PortableServer.Servant, CORBA.IInvokeHandler, IExceptionDefOperations
	{
		static private Dictionary<string,int> _opsDict = new Dictionary<string,int>();
		static ExceptionDefPOA()
		{
			...
			_opsDict.Add("lookup", 13);
			_opsDict.Add("contents", 14);
			_opsDict.Add("lookup_name", 15);
			_opsDict.Add("describe_contents", 16);
			_opsDict.Add("create_module", 17);
			_opsDict.Add("create_constant", 18);
			_opsDict.Add("create_struct", 19);
			_opsDict.Add("create_union", 20);
			_opsDict.Add("create_enum", 21);
			_opsDict.Add("create_alias", 22);
			_opsDict.Add("create_interface", 23);
			_opsDict.Add("create_value", 24);
			_opsDict.Add("create_value_box", 25);
			_opsDict.Add("create_exception", 26);
			_opsDict.Add("create_native", 27);
			_opsDict.Add("create_abstract_interface", 28);
			_opsDict.Add("create_local_interface", 29);
			_opsDict.Add("create_ext_value", 30);
			_opsDict.Add("_get_type", 31);
			_opsDict.Add("_set_members", 32);
			_opsDict.Add("_get_members", 33);
		}
		private string[] _ids = {"IDL:CORBA/ExceptionDef:1.0","IDL:CORBA/Contained:1.0","IDL:CORBA/Container:1.0"};
		...
		[IdlName("members")]
		public abstract CORBA.StructMember[] Members 
		{
			get;
		...
		public virtual CORBA.IExceptionDef _This()
		{
			return CORBA.ExceptionDefHelper.Narrow(_ThisObject());
		}

		public virtual CORBA.IExceptionDef _This(CORBA.ORB orb)
		{
			return CORBA.ExceptionDefHelper.Narrow(_ThisObject(orb));
		}
