...
namespace CORBA
{
	public class _StructDefStub: CORBA.Object, IStructDef
	{
		private new string[] _ids = {"IDL:CORBA/StructDef:1.0","IDL:CORBA/TypedefDef:1.0","IDL:CORBA/Container:1.0"};
		...
		public static Type _opsType = typeof(IStructDefOperations);
