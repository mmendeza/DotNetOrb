...
namespace CORBA
{
	public static class ORBidHelper
	{
		...
		public static CORBA.TypeCode Type()
		{
			if (type == null)
			{
				lock (typeof(ORBidHelper))
				{
					if (type == null)
					{
						type = CORBA.ORB.Init().CreateAliasTc(CORBA.ORBidHelper.Id(), "ORBid", CORBA.ORB.Init().CreateStringTc(0));
					}
				}
			}
			return type;
