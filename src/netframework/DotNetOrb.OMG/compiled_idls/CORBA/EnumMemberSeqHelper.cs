...
namespace CORBA
{
	public static class EnumMemberSeqHelper
	{
		...
		public static CORBA.TypeCode Type()
		{
			if (type == null)
			{
				lock (typeof(EnumMemberSeqHelper))
				{
					if (type == null)
					{
						type = CORBA.ORB.Init().CreateAliasTc(CORBA.EnumMemberSeqHelper.Id(), "EnumMemberSeq", CORBA.ORB.Init().CreateSequenceTc(0, CORBA.ORB.Init().CreateStringTc(0)));
					}
				}
			}
			return type;
		...
		{
			return "IDL:CORBA/EnumMemberSeq:1.0";
		}
