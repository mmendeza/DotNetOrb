...
namespace CORBA
{
	public class _EnumDefStub: CORBA.Object, IEnumDef
	{
		private new string[] _ids = {"IDL:CORBA/EnumDef:1.0","IDL:CORBA/TypedefDef:1.0"};
		...
		public static Type _opsType = typeof(IEnumDefOperations);
