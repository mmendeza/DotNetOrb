...
namespace CORBA
{
	...
	public abstract class WstringDefPOA: PortableServer.Servant, CORBA.IInvokeHandler, IWstringDefOperations
	{
		static private Dictionary<string,int> _opsDict = new Dictionary<string,int>();
		static WstringDefPOA()
		{
		...
		private string[] _ids = {"IDL:CORBA/WstringDef:1.0","IDL:CORBA/IDLType:1.0"};
		...
		public virtual CORBA.IWstringDef _This()
		{
			return CORBA.WstringDefHelper.Narrow(_ThisObject());
		}

		public virtual CORBA.IWstringDef _This(CORBA.ORB orb)
		{
