...
namespace CORBA
{
	public static class ServiceDetailDataHelper
	{
		...
		public static CORBA.TypeCode Type()
		{
			if (type == null)
			{
				lock (typeof(ServiceDetailDataHelper))
				{
					if (type == null)
					{
						type = CORBA.ORB.Init().CreateAliasTc(CORBA.ServiceDetailDataHelper.Id(), "ServiceDetailData", CORBA.ORB.Init().CreateSequenceTc(0, CORBA.ORB.Init().GetPrimitiveTc((CORBA.TCKind) 10)));
					}
				}
			}
			return type;
		...
		{
			return "IDL:CORBA/ServiceDetailData:1.0";
		}
