...
namespace CORBA
{
	public class _AbstractInterfaceDefStub: CORBA.Object, IAbstractInterfaceDef
	{
		private new string[] _ids = {"IDL:CORBA/AbstractInterfaceDef:1.0","IDL:CORBA/InterfaceDef:1.0"};
		...
		public static Type _opsType = typeof(IAbstractInterfaceDefOperations);
