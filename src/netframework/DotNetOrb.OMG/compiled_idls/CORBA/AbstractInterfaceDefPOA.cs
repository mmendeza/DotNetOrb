...
namespace CORBA
{
	...
	public abstract class AbstractInterfaceDefPOA: PortableServer.Servant, CORBA.IInvokeHandler, IAbstractInterfaceDefOperations
	{
		static private Dictionary<string,int> _opsDict = new Dictionary<string,int>();
		static AbstractInterfaceDefPOA()
		{
		...
		private string[] _ids = {"IDL:CORBA/AbstractInterfaceDef:1.0","IDL:CORBA/InterfaceDef:1.0"};
		...
		public virtual CORBA.IAbstractInterfaceDef _This()
		{
			return CORBA.AbstractInterfaceDefHelper.Narrow(_ThisObject());
		}

		public virtual CORBA.IAbstractInterfaceDef _This(CORBA.ORB orb)
		{
			return CORBA.AbstractInterfaceDefHelper.Narrow(_ThisObject(orb));
		}
