...
namespace TimeBase
{
	public static class InaccuracyTHelper
	{
		...
		public static CORBA.TypeCode Type()
		{
			if (type == null)
			{
				lock (typeof(InaccuracyTHelper))
				{
					if (type == null)
					{
						type = CORBA.ORB.Init().CreateAliasTc(TimeBase.InaccuracyTHelper.Id(), "InaccuracyT", CORBA.ORB.Init().GetPrimitiveTc((CORBA.TCKind) 24));
					}
				}
			}
			return type;
