...
namespace CSIIOP
{
	public static class AssociationOptionsHelper
	{
		...
		public static CORBA.TypeCode Type()
		{
			if (type == null)
			{
				lock (typeof(AssociationOptionsHelper))
				{
					if (type == null)
					{
						type = CORBA.ORB.Init().CreateAliasTc(CSIIOP.AssociationOptionsHelper.Id(), "AssociationOptions", CORBA.ORB.Init().GetPrimitiveTc((CORBA.TCKind) 2));
					}
				}
			}
			return type;
		...
		{
			return "IDL:CSIIOP/AssociationOptions:1.0";
		}
