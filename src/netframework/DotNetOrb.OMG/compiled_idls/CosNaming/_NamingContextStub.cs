...
namespace CosNaming
{
	public class _NamingContextStub: CORBA.Object, INamingContext
	{
		private new string[] _ids = {"IDL:omg.org/CosNaming/NamingContext:1.0"};
		...
		public static Type _opsType = typeof(INamingContextOperations);
