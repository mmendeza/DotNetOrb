...
namespace IOP
{
	public static class ServiceIdHelper
	{
		...
		public static CORBA.TypeCode Type()
		{
			if (type == null)
			{
				lock (typeof(ServiceIdHelper))
				{
					if (type == null)
					{
						type = CORBA.ORB.Init().CreateAliasTc(IOP.ServiceIdHelper.Id(), "ServiceId", CORBA.ORB.Init().GetPrimitiveTc((CORBA.TCKind) 5));
					}
				}
			}
			return type;
