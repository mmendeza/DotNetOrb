...
namespace IOP
{
	public static class ComponentDataHelper
	{
		...
		public static CORBA.TypeCode Type()
		{
			if (type == null)
			{
				lock (typeof(ComponentDataHelper))
				{
					if (type == null)
					{
						type = CORBA.ORB.Init().CreateAliasTc(IOP.ComponentDataHelper.Id(), "ComponentData", CORBA.ORB.Init().CreateSequenceTc(0, CORBA.ORB.Init().GetPrimitiveTc((CORBA.TCKind) 10)));
					}
				}
			}
			return type;
		...
		{
			return "IDL:IOP/ComponentData:1.0";
		}
