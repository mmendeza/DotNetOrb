...
{
	public static class GroupDomainIdHelper
	{
		...
		public static CORBA.TypeCode Type()
		{
			if (type == null)
			{
				lock (typeof(GroupDomainIdHelper))
				{
					if (type == null)
					{
						type = CORBA.ORB.Init().CreateAliasTc(PortableGroup.GroupDomainIdHelper.Id(), "GroupDomainId", CORBA.ORB.Init().CreateStringTc(0));
					}
				}
			}
			return type;
