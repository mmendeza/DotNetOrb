...
namespace PortableGroup
{
	public static class CriteriaHelper
	{
		...
		public static CORBA.TypeCode Type()
		{
			if (type == null)
			{
				lock (typeof(CriteriaHelper))
				{
					if (type == null)
					{
						type = CORBA.ORB.Init().CreateAliasTc(PortableGroup.CriteriaHelper.Id(), "Criteria", CORBA.ORB.Init().CreateSequenceTc(0, PortableGroup.PropertyHelper.Type()));
					}
				}
			}
			return type;
