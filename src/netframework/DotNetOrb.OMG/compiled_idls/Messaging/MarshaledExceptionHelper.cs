...
namespace Messaging
{
	public static class MarshaledExceptionHelper
	{
		...
		public static CORBA.TypeCode Type()
		{
			if (type == null)
			{
				lock (typeof(MarshaledExceptionHelper))
				{
					if (type == null)
					{
						type = CORBA.ORB.Init().CreateAliasTc(Messaging.MarshaledExceptionHelper.Id(), "MarshaledException", CORBA.ORB.Init().CreateSequenceTc(0, CORBA.ORB.Init().GetPrimitiveTc((CORBA.TCKind) 10)));
					}
				}
			}
			return type;
		...
		{
			return "IDL:Messaging/MarshaledException:1.0";
		}
