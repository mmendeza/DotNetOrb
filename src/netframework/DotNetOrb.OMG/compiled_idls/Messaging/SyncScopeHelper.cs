...
namespace Messaging
{
	public static class SyncScopeHelper
	{
		...
		public static CORBA.TypeCode Type()
		{
			if (type == null)
			{
				lock (typeof(SyncScopeHelper))
				{
					if (type == null)
					{
						type = CORBA.ORB.Init().CreateAliasTc(Messaging.SyncScopeHelper.Id(), "SyncScope", CORBA.ORB.Init().GetPrimitiveTc((CORBA.TCKind) 4));
					}
				}
			}
			return type;
		...
		{
			return "IDL:Messaging/SyncScope:1.0";
		}
