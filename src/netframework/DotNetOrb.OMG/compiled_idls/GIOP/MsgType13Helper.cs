...
namespace GIOP
{
	public static class MsgType13Helper
	{
		...
		public static CORBA.TypeCode Type()
		{
			if (type == null)
			{
				lock (typeof(MsgType13Helper))
				{
					if (type == null)
					{
						type = CORBA.ORB.Init().CreateAliasTc(GIOP.MsgType13Helper.Id(), "MsgType_1_3", GIOP.MsgType11Helper.Type());
					}
				}
			}
			return type;
		...
		{
			return "IDL:GIOP/MsgType_1_3:1.0";
		}
