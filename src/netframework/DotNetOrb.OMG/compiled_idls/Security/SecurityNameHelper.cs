...
namespace Security
{
	public static class SecurityNameHelper
	{
		...
		public static CORBA.TypeCode Type()
		{
			if (type == null)
			{
				lock (typeof(SecurityNameHelper))
				{
					if (type == null)
					{
						type = CORBA.ORB.Init().CreateAliasTc(Security.SecurityNameHelper.Id(), "SecurityName", CORBA.ORB.Init().CreateStringTc(0));
					}
				}
			}
			return type;
