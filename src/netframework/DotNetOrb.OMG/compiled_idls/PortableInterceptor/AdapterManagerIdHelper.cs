...
{
	public static class AdapterManagerIdHelper
	{
		...
		public static CORBA.TypeCode Type()
		{
			if (type == null)
			{
				lock (typeof(AdapterManagerIdHelper))
				{
					if (type == null)
					{
						type = CORBA.ORB.Init().CreateAliasTc(PortableInterceptor.AdapterManagerIdHelper.Id(), "AdapterManagerId", CORBA.ORB.Init().CreateStringTc(0));
					}
				}
			}
			return type;
		...
		{
			return "IDL:PortableInterceptor/AdapterManagerId:1.0";
		}
