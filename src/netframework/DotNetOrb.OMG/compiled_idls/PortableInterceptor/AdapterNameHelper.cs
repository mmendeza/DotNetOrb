...
{
	public static class AdapterNameHelper
	{
		...
		public static CORBA.TypeCode Type()
		{
			if (type == null)
			{
				lock (typeof(AdapterNameHelper))
				{
					if (type == null)
					{
						type = CORBA.ORB.Init().CreateAliasTc(PortableInterceptor.AdapterNameHelper.Id(), "AdapterName", CORBA.ORB.Init().CreateSequenceTc(0, CORBA.ORB.Init().CreateStringTc(0)));
					}
				}
			}
			return type;
		...
		{
			return "IDL:PortableInterceptor/AdapterName:1.0";
		}
