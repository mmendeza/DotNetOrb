...
{
	public static class ReplyStatusHelper
	{
		...
		public static CORBA.TypeCode Type()
		{
			if (type == null)
			{
				lock (typeof(ReplyStatusHelper))
				{
					if (type == null)
					{
						type = CORBA.ORB.Init().CreateAliasTc(PortableInterceptor.ReplyStatusHelper.Id(), "ReplyStatus", CORBA.ORB.Init().GetPrimitiveTc((CORBA.TCKind) 4));
					}
				}
			}
			return type;
		...
		{
			return "IDL:PortableInterceptor/ReplyStatus:1.0";
		}
