...
namespace Dynamic
{
	public static class RequestContextHelper
	{
		...
		public static CORBA.TypeCode Type()
		{
			if (type == null)
			{
				lock (typeof(RequestContextHelper))
				{
					if (type == null)
					{
						type = CORBA.ORB.Init().CreateAliasTc(Dynamic.RequestContextHelper.Id(), "RequestContext", CORBA.ORB.Init().CreateSequenceTc(0, CORBA.ORB.Init().CreateStringTc(0)));
					}
				}
			}
			return type;
		...
		{
			return "IDL:Dynamic/RequestContext:1.0";
		}
