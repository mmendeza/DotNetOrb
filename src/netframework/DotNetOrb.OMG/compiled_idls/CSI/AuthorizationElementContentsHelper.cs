...
namespace CSI
{
	public static class AuthorizationElementContentsHelper
	{
		...
		public static CORBA.TypeCode Type()
		{
			if (type == null)
			{
				lock (typeof(AuthorizationElementContentsHelper))
				{
					if (type == null)
					{
						type = CORBA.ORB.Init().CreateAliasTc(CSI.AuthorizationElementContentsHelper.Id(), "AuthorizationElementContents", CORBA.ORB.Init().CreateSequenceTc(0, CORBA.ORB.Init().GetPrimitiveTc((CORBA.TCKind) 10)));
					}
				}
			}
			return type;
		...
		{
			return "IDL:CSI/AuthorizationElementContents:1.0";
		}
