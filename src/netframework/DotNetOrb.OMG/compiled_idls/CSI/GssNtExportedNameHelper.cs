...
namespace CSI
{
	public static class GssNtExportedNameHelper
	{
		...
		public static CORBA.TypeCode Type()
		{
			if (type == null)
			{
				lock (typeof(GssNtExportedNameHelper))
				{
					if (type == null)
					{
						type = CORBA.ORB.Init().CreateAliasTc(CSI.GssNtExportedNameHelper.Id(), "GSS_NT_ExportedName", CORBA.ORB.Init().CreateSequenceTc(0, CORBA.ORB.Init().GetPrimitiveTc((CORBA.TCKind) 10)));
					}
				}
			}
			return type;
		...
		{
			return "IDL:CSI/GSS_NT_ExportedName:1.0";
		}
