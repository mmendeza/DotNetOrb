...
namespace CSI
{
	public static class IdentityTokenTypeHelper
	{
		...
		public static CORBA.TypeCode Type()
		{
			if (type == null)
			{
				lock (typeof(IdentityTokenTypeHelper))
				{
					if (type == null)
					{
						type = CORBA.ORB.Init().CreateAliasTc(CSI.IdentityTokenTypeHelper.Id(), "IdentityTokenType", CORBA.ORB.Init().GetPrimitiveTc((CORBA.TCKind) 5));
					}
				}
			}
			return type;
		...
		{
			return "IDL:CSI/IdentityTokenType:1.0";
		}
