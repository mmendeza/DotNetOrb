...
namespace CSI
{
	public static class X501DistinguishedNameHelper
	{
		...
		public static CORBA.TypeCode Type()
		{
			if (type == null)
			{
				lock (typeof(X501DistinguishedNameHelper))
				{
					if (type == null)
					{
						type = CORBA.ORB.Init().CreateAliasTc(CSI.X501DistinguishedNameHelper.Id(), "X501DistinguishedName", CORBA.ORB.Init().CreateSequenceTc(0, CORBA.ORB.Init().GetPrimitiveTc((CORBA.TCKind) 10)));
					}
				}
			}
			return type;
		...
		{
			return "IDL:CSI/X501DistinguishedName:1.0";
		}
