...
namespace CSI
{
	public static class AuthorizationElementTypeHelper
	{
		...
		public static CORBA.TypeCode Type()
		{
			if (type == null)
			{
				lock (typeof(AuthorizationElementTypeHelper))
				{
					if (type == null)
					{
						type = CORBA.ORB.Init().CreateAliasTc(CSI.AuthorizationElementTypeHelper.Id(), "AuthorizationElementType", CORBA.ORB.Init().GetPrimitiveTc((CORBA.TCKind) 5));
					}
				}
			}
			return type;
		...
		{
			return "IDL:CSI/AuthorizationElementType:1.0";
		}
