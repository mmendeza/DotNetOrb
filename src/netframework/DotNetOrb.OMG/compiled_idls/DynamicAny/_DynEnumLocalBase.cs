...
{
	public abstract class _DynEnumLocalBase: CORBA.LocalObject, IDynEnum
	{
		private string[] _ids = {"IDL:DynamicAny/DynEnum:1.0","IDL:DynamicAny/DynAny:1.0"};
		...
		[ThrowsIdlException(typeof(DynamicAny.DynAny.InvalidValue))]
		public abstract void SetAsString([WideChar(false)] string value);
		[IdlName("get_as_ulong")]
		public abstract uint GetAsUlong();
		[IdlName("set_as_ulong")]
		[ThrowsIdlException(typeof(DynamicAny.DynAny.InvalidValue))]
		public abstract void SetAsUlong(uint value);
	}
