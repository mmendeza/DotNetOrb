...
{
	public abstract class _DynSequenceLocalBase: CORBA.LocalObject, IDynSequence
	{
		private string[] _ids = {"IDL:DynamicAny/DynSequence:1.0","IDL:DynamicAny/DynAny:1.0"};
		...
		[IdlName("set_length")]
		[ThrowsIdlException(typeof(DynamicAny.DynAny.InvalidValue))]
		public abstract void SetLength(uint len);
		[IdlName("get_elements")]
		public abstract CORBA.Any[] GetElements();
		[IdlName("set_elements")]
		[ThrowsIdlException(typeof(DynamicAny.DynAny.TypeMismatch))]
		[ThrowsIdlException(typeof(DynamicAny.DynAny.InvalidValue))]
		public abstract void SetElements(CORBA.Any[] value);
		[IdlName("get_elements_as_dyn_any")]
		public abstract DynamicAny.IDynAny[] GetElementsAsDynAny();
		[IdlName("set_elements_as_dyn_any")]
		[ThrowsIdlException(typeof(DynamicAny.DynAny.TypeMismatch))]
		[ThrowsIdlException(typeof(DynamicAny.DynAny.InvalidValue))]
		public abstract void SetElementsAsDynAny(DynamicAny.IDynAny[] value);
	}
