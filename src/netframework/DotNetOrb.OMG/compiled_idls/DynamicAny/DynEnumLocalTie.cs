...
namespace DynamicAny
{
	...
	public class DynEnumLocalTie: _DynEnumLocalBase
	{
		public IDynEnumOperations _OperationsDelegate { get; set; }

		public DynEnumLocalTie(IDynEnumOperations d)
		{
		...
		{
			return _OperationsDelegate.GetAsString();
		}
		[IdlName("set_as_string")]
		[ThrowsIdlException(typeof(DynamicAny.DynAny.InvalidValue))]
		public override void SetAsString([WideChar(false)] string value)
		{
			_OperationsDelegate.SetAsString(value);
		}
		[IdlName("get_as_ulong")]
		public override uint GetAsUlong()
		{
			return _OperationsDelegate.GetAsUlong();
		}
		[IdlName("set_as_ulong")]
		[ThrowsIdlException(typeof(DynamicAny.DynAny.InvalidValue))]
		public override void SetAsUlong(uint value)
		{
			_OperationsDelegate.SetAsUlong(value);
		}
	}
}
