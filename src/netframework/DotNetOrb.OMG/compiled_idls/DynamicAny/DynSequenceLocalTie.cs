...
namespace DynamicAny
{
	...
	public class DynSequenceLocalTie: _DynSequenceLocalBase
	{
		public IDynSequenceOperations _OperationsDelegate { get; set; }

		public DynSequenceLocalTie(IDynSequenceOperations d)
		{
		...
		{
			return _OperationsDelegate.GetLength();
		}
		[IdlName("set_length")]
		[ThrowsIdlException(typeof(DynamicAny.DynAny.InvalidValue))]
		public override void SetLength(uint len)
		{
			_OperationsDelegate.SetLength(len);
		}
