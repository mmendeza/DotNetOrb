...
{
	public abstract class _DynFixedLocalBase: CORBA.LocalObject, IDynFixed
	{
		private string[] _ids = {"IDL:DynamicAny/DynFixed:1.0","IDL:DynamicAny/DynAny:1.0"};
		...
		[ThrowsIdlException(typeof(DynamicAny.DynAny.TypeMismatch))]
		[ThrowsIdlException(typeof(DynamicAny.DynAny.InvalidValue))]
		public abstract bool SetValue([WideChar(false)] string val);
	}
