...
{
	public static class CodeSetIdHelper
	{
		...
		public static CORBA.TypeCode Type()
		{
			if (type == null)
			{
				lock (typeof(CodeSetIdHelper))
				{
					if (type == null)
					{
						type = CORBA.ORB.Init().CreateAliasTc(CONV_FRAME.CodeSetIdHelper.Id(), "CodeSetId", CORBA.ORB.Init().GetPrimitiveTc((CORBA.TCKind) 5));
					}
				}
			}
			return type;
		...
		{
			return "IDL:CONV_FRAME/CodeSetId:1.0";
		}
