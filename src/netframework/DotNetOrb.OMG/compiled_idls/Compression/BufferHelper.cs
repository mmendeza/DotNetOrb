...
namespace Compression
{
	public static class BufferHelper
	{
		...
		public static CORBA.TypeCode Type()
		{
			if (type == null)
			{
				lock (typeof(BufferHelper))
				{
					if (type == null)
					{
						type = CORBA.ORB.Init().CreateAliasTc(Compression.BufferHelper.Id(), "Buffer", CORBA.ORB.Init().CreateSequenceTc(0, CORBA.ORB.Init().GetPrimitiveTc((CORBA.TCKind) 10)));
					}
				}
			}
			return type;
